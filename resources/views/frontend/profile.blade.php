...
@section('dashboard')
    <main>
        <div class="space-y-5 md:space-y-8 text-[#191919]">
            <!--  Account Settings -->
            <div class="space-y-4 border border-[#E5E5E5] rounded-sm md:pb-4 pb-3">
                <h2
                    class="sm:text-base text-sm font-semibold border-b border-[#E5E5E5] px-3 py-1.5 md:px-5 md:py-3 text-[#191919]">
                    Account Settings
                </h2>
                ...
                <form spellcheck="false" action="{{ route('accountUpdate') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <!-- Display image -->
            <div
                class="display-image w-20 h-20 xsm:w-32 xsm:h-32 md:w-36 md:h-36 xl:w-40 xl:h-40 rounded-full overflow-hidden border border-[#E5E5E5] relative group/avater">
                        @if ($user->image)
            ...
            <label for="dropzone-file"
                class="group-hover/avater:opacity-90 opacity-0 absolute flex flex-col items-center justify-center p-4 top-0 left-0 w-full h-full border-2 border-dashed rounded-full cursor-pointer bg-gray-100 text-center eq">
                <svg class="size-7 xsm:size-8 mb-2 text-[#767676]" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M13 13h3a3 3 0 0 0 0-6h-.025A5.56 5.56 0 0 0 16 6.5 5.5 5.5 0 0 0 5.207 5.021C5.137 5.017 5.071 5 5 5a4 4 0 0 0 0 8h2.167M10 15V6m0 0L8 8m2-2 2 2" />
                            </svg>
                <p class="hidden xsm:block text-xs text-[#767676]">
                    ...
                    <div class="flex-1 space-y-3 sm:space-y-5">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-2 sm:gap-4">
                            <div class="from-ctrl space-y-1 sm:space-y-2">
                                ...
                                <input required type="text" id="full-name" name="name"
                                    ...
                                    class="eq w-full px-3 py-2 border border-gray-300 rounded focus:outline-2 focus:outline-[#F85606]/30 text-sm md:text-base" />
                            </div>
                            <div class="from-ctrl space-y-1 sm:space-y-2">
                        ...
                        <button type="submit"
                            class="bg-[#F85606] text-white px-5 py-2 border-2 border-transparent rounded text-xs md:text-sm uppercase font-bold mt-3 md:mt-5 hover:bg-[#C43D00] eq">
                            save changes
                        </button>
                    </div>
                </form>
            ...
            <div class="grid grid-cols-1 gap-5 md:gap-8">
                <!-- billing -->
            <div class="billing-address space-y-4 border border-[#E5E5E5] rounded-sm md:pb-4 pb-3">
                <h2
                    class="sm:text-base text-sm font-semibold border-b border-[#E5E5E5] px-3 py-1.5 md:px-5 md:py-3 text-[#191919]">
                    Billing Address
                </h2>
            ...
            <!-- Change Password -->
            <div class="change-password space-y-4 border border-[#E5E5E5] rounded-sm md:pb-4 pb-3">
                <h2
                    class="sm:text-base text-sm font-semibold border-b border-[#E5E5E5] px-3 py-1.5 md:px-5 md:py-3 text-[#191919]">
                    Change Password
                </h2>
                ...
                <form spellcheck="false" action="{{ route('updatePassword') }}" method="POST"
                    ...
                    <div class="from-ctrl space-y-1 sm:space-y-2 w-full">
                        ...
                        <div class="relative">
                            <input type="password"
                                class="eq w-full pl-3 pr-10 py-2 border border-gray-300 rounded focus:outline-2 focus:outline-[#F85606]/30 text-sm md:text-base"
                    ...
                    <button type="submit"
                        class="bg-[#F85606] text-white px-5 py-2 border-2 border-transparent rounded text-xs md:text-sm uppercase font-bold mt-1 md:mt-2 hover:bg-[#C43D00] eq">
                        Change Passowrd
                    </button>
                </form>
            </div>
