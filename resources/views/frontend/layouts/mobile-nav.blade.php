<div
    ...
    <a href="{{ route('home') }}" class="flex flex-col items-center gap-1 {{ request()->routeIs('home') ? 'text-primary-600': '' }} hover:text-primary-600">
        <i class="fas fa-home text-lg"></i>
        <span class="text-[10px] font-medium">Home</span>
    </a>
    <a href="{{ route('products.index') }}" class="flex flex-col items-center gap-1 {{ request()->routeIs('products.index') ? 'text-primary-600': '' }} hover:text-primary-600">
        <i class="fas fa-th-large text-lg"></i>
        <span class="text-[10px] font-medium">Shop</span>
    </a>
    <a href="#" class="flex flex-col items-center gap-1 {{ request()->routeIs('cart.details') ? 'text-primary-600': '' }} hover:text-primary-600 relative">
        <div class="relative">
