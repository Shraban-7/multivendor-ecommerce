        ...
        <div class="flex items-center h-14 sm:h-16">
            ...
            <div class="flex items-center flex-shrink-0">
                ...
                <a href="{{ route('cart.details') }}" class="relative p-2 rounded hover:bg-[#FFF1EA] eq" aria-label="Shopping cart">
                    ...
                    <span class="absolute -top-0.5 -right-0.5 bg-[#F85606] text-white text-[10px] font-bold min-w-[16px] h-[16px] flex items-center justify-center rounded-full" aria-live="polite" id="cartCount">{{ $cartCount }}</span>
                </a>
            </div>
        </div>
