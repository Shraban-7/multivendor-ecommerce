    ...
    <div class="container mx-auto mt-6">
        ...
        <div id="reviews-content" class="tab-content hidden bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div class="p-4 bg-gray-50 border border-gray-100 rounded-lg">
                ...
                <p class="mt-2 text-sm text-gray-500">Total Reviews: <span class="font-semibold">{{ $seller->totalReviews }}</span> | Average Rating: <span class="font-semibold">{{ number_format($avgRating, 2) }}</span></p>
            </div>
            <div class="mt-6 space-y-4">
                <div class="border-b pb-4">
                    <p class="font-semibold text-gray-900">User A</p>
                    <div class="text-yellow-500 text-sm">★★★★★</div>
                    <p class="text-gray-700 text-sm">Great products and fast shipping!</p>
                </div>
                <div class="border-b pb-4">
                    <p class="font-semibold text-gray-900">User B</p>
                    <div class="text-yellow-500 text-sm">★★★★☆</div>
                    <p class="text-gray-700 text-sm">Good quality, but shipping was slow.</p>
                </div>
            </div>
        </div>
        ...
        tabLinks.forEach(link => {
            link.addEventListener('click', function(e) {
                ...
                tabLinks.forEach(tab => {
                    ...
                    tab.classList.add('border-transparent', 'text-gray-500', 'hover:text-gray-800');
                });

                // 2. Activate the clicked tab visually
                this.classList.add('border-primary-600', 'text-primary-600');
                this.classList.remove('border-transparent', 'text-gray-500', 'hover:text-gray-800');
