...
<main class="shop-details-page">
      ...
      <section class="w-full bg-black text-white py-2 md:py-4">
        <div
          class="container mx-auto flex flex-col xsm:flex-row flex-wrap justify-between items-center px-4"
        >
          <div
          ...
          <div
            class="flex items-center p-2 md:p-0 justify-center gap-2 text-[#FFF7A7]"
          >
      ...
      <section class="products-section py-8 container">
        ...
        <div class="shop-header">
          <div class="flex flex-wrap gap-y-2 justify-between items-center">
            ...
            <div class="flex items-center gap-2 md:gap-4">
              <div
                class="w-14 md:w-20 h-14 md:h-20 rounded-full overflow-hidden"
              >
                <img
                  src="{{ asset('assets/frontend/images/provider-logo-1.png') }}"
              ...
              <div class="flex flex-col md:gap-2">
                <h1 class="text-xl md:text-2xl font-light">Louis Vuitton</h1>
                <div class="flex items-center gap-1 flex-nowrap text-sm">
                  <i
                    class="fa-solid fa-circle-check text-butterfly-blue md:text-xl"
                  ></i>
            ...
            <div class="flex flex-col gap-2 text-center">
              <div
                class="flex items-center gap-10 text-davy-gray text-sm md:text-base"
              >
                <div class="followers">
        ...
        <div class="shop-links">
          ...
          >
            <a href="/shopDetails.html" class="hover:text-black eq">Items</a>
            ...
            <a
              href="/shopReviews.html"
              class="text-black hover:text-black eq inline-flex items-center gap-1 flex-nowrap"
              >Reviews (5.00<i class="fa-solid fa-star text-xs"></i>)</a
            >
            <!-- shop product search -->
            <div
              class="xsm:w-6/12 md:w-5/12 lg:w-3/12 w-9/12 mr-auto xsm:ml-auto sm:mr-0 sm:ml-auto"
            >
              <div class="relative">
                <input
                  type="text"
                  placeholder="Search all 212 items"
        ...
        <div class="flex flex-col md:flex-row gap-5 items-start py-2 md:py-4">
          <div class="lg:w-4/12 md:w-[50%] w-full">
            ...
            <div class="flex items-start gap-4">
              <div class="space-y-1">
                <div class="text-3xl md:text-4xl text-persian-blue">94.0%</div>
                <div class="flex text-yellow-400 text-2xl md:text-3xl">
                  ★★★★★
                </div>
                <div class="text-davy-gray text-xs sm:text-sm">
                  (Positive reviews)
                  <span class="text-primary/80 font-semibold lg:pl-2">Top</span>
                </div>
              </div>

              <!-- Rating Bars -->
              <div
                class="ratings-wrap w-full sm:w-2/4 md:w-3/4 2xl:w-1/2 lg:w-7/12 space-y-1"
              >
                <!-- 5 star -->
                <div class="flex gap-2 md:gap-5 w-full items-center gap-2">
                  ...
                  <span class="text-xs text-persian-blue">(05 star)</span>
                </div>
                <!-- 4 star -->
                <div class="flex gap-2 md:gap-5 w-full items-center gap-2">
                  <div class="w-1/2 sm:w-5/12 md:w-7/12 lg:w-1/2 2xl:w-7/12">
                  ...
                  <span class="text-xs text-persian-blue">(04 star)</span>
                </div>
                <!-- 3 star -->
                <div class="flex gap-2 md:gap-5 w-full items-center gap-2">
                  <div class="w-1/2 sm:w-5/12 md:w-7/12 lg:w-1/2 2xl:w-7/12">
                  ...
                  <span class="text-xs text-persian-blue">(03 star)</span>
                </div>
                <!-- 2 star -->
                <div class="flex gap-2 md:gap-5 w-full items-center gap-2">
                  <div class="w-1/2 sm:w-5/12 md:w-7/12 lg:w-1/2 2xl:w-7/12">
                  ...
                  <span class="text-xs text-persian-blue">(02 star)</span>
                </div>
                <!-- 1 star -->
                <div class="flex gap-2 md:gap-5 w-full items-center gap-2">
                  <div class="w-1/2 sm:w-5/12 md:w-7/12 lg:w-1/2 2xl:w-7/12">
                  ...
                  <span class="text-xs text-persian-blue">(01 star)</span>
                </div>
              </div>
            </div>
          ...
          <div class="lg:w-8/12 md:w-[50%] w-full md:px-2 xl:px-3">
            ...
            <div class="my-2 flex flex-wrap items-center justify-between">
              <h6 class="text-persian-blue md:text-lg">359 reviews</h6>
              <form
                class="items-center gap-1 xsm:gap-2 md:gap-3 sm:text-sm text-xs flex text-theme-dark"
              >
                <label
                  for="sort-by"
                  class="block whitespace-nowrap text-jet-gray"
                  >Sort By</label
                >
                <select
                  id="sort-by"
            ...
            <h3
              class="inline-block px-3 pr-10 py-2.5 bg-theme-teal/5 text-theme-teal space-x-2 text-sm mb-5"
            >
            ...
            <div class="comments-tags text-xs lg:text-sm text-davy-gray">
              ...
              <!-- review tags -->
              <div
                class="review-tags flex flex-wrap gap-2 mt-2 md:mt-4 font-medium"
              >
                <button
                  class="inline-flex items-center lg:px-3 px-2 py-1 rounded-full border border-jet-gray gap-2"
                >
                  <span class="flag-wrap h-4 lg:h-6 w-auto"
                    ><img
                ...
                <button
                  class="inline-flex items-center lg:px-3 px-3 py-1 rounded-full border border-jet-gray"
                >
                  Gift (90)
                </button>
                <button
              ...
              >
                ...
                <div class="review-item space-y-2 py-6">
                  <div class="flex items-center gap-3">
                    <div
                      class="user-avatar w-12 h-12 rounded-full overflow-hidden"
                    >
                      <img
                        src="{{ asset('assets/frontend/images/user-avatar-1.png') }}"
                        alt="Alan Walker"
                      />
                    </div>
                  ...
                  <div class="rating flex flex-wrap items-center gap-3">
                    <div
                      class="flex flex-nowrap gap-1 text-theme-dark text-xs md:text-sm"
                    >
                      <i class="fa-solid fa-star"></i>
                      <i class="fa-solid fa-star"></i>
                      <i class="fa-solid fa-star"></i>
                    ...
                    <span class="text-davy-gray text-lg sm:text-xl font-medium"
                      >5.0</span
                    >
                  </div>
                  <!-- colour -->
                  ...
                  <div class="flex product-images gap-2 md:gap-3 py-2">
                    <div
                      class="img-wrap w-1/3 h-28 sm:h-32 md:h-24 lg:h-36 overflow-hidden rounded-xl"
                    >
                      <img
                        src="{{ asset('assets/frontend/images/review-prod-1.png') }}"
                        alt=""
                        class="w-full h-full object-cover"
                      />
                    </div>
                    ...
                    >
                      <img
                        src="{{ asset('assets/frontend/images/review-prod-2.png') }}"
                        alt=""
                        class="w-full h-full object-cover"
                      />
                    </div>
                    ...
                    >
                      <img
                        src="{{ asset('assets/frontend/images/review-prod-3.png') }}"
                        alt=""
                        class="w-full h-full object-cover"
                      />
                    </div>
                  ...
                  >
                    <div
                      class="flex items-start divide-x divide-black gap-3 pt-2"
                    >
                      <button
                        class="flex items-center gap-2 hover:text-primary eq"
                      >
                        <svg
                          class="w-5 h-5"
                          width="26"
                      ...
                      <button
                        class="pl-2 flex items-center gap-2 hover:text-butterfly-blue eq"
                      >
                        <svg
                          class="w-5 h-5"
                          fill="none"
                    ...
                    <button
                      class="ml-auto text-xl md:text-2xl lg:text-3xl"
                      id="alan-walker-btn"
                      data-dropdown-toggle="alan-walker-comment-dropdown"
                      type="button"
                    >
                ...
                <div class="review-item space-y-2 py-6">
                  <div class="flex items-center gap-3">
                    ...
                    >
                      <img
                        src="{{ asset('assets/frontend/images/user-avatar-2.png') }}"
                        alt="Josesph Man"
                      />
                    </div>
                    <div class="flex flex-wrap items-center gap-x-2 gap-y-1">
                  ...
                  <div class="flex product-images gap-2 md:gap-3 py-2">
                    ...
                    >
                      <img
                        src="{{ asset('assets/frontend/images/review-prod-4.png') }}"
                        alt=""
                        class="w-full h-full object-cover"
                      />
                    </div>
                    ...
                    >
                      <img
                        src="{{ asset('assets/frontend/images/review-prod-5.png') }}"
                        alt=""
                        class="w-full h-full object-cover"
                      />
                    </div>
                    ...
                    >
                      <img
                        src="{{ asset('assets/frontend/images/review-prod-6.png') }}"
                        alt=""
                        class="w-full h-full object-cover"
                      />
                    </div>
                  ...
                  >
                    ...
                    <button
                      class="ml-auto text-xl md:text-2xl lg:text-3xl"
                      id="josesph-man-btn"
                      data-dropdown-toggle="josesph-man-comment-dropdown"
                      type="button"
                    >
                      <i class="fa-solid fa-ellipsis"></i>
                    </button>
                    ...
                    <!-- Dropdown menu -->
                    <div
                      id="josesph-man-comment-dropdown"
                      class="z-30 hidden bg-white divide-y divide-gray-100 rounded-lg shadow-lg w-38 md:w-44"
                    >
                      <div
                        class="py-2 text-sm text-gray-700"
                        aria-labelledby="josesph-man-btn"
                      >
                        <button
                          class="block w-full text-left px-4 py-2 hover:bg-gray-100"
                        >
