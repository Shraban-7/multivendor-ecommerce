                ...
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3 mb-3">
                    ...
                    <form class="w-full md:w-auto">
                        <select id="sort-by"
                            ...
                            <option value="">Sort By: Relevance</option> {{-- ✅ Fix: make value empty --}}
    ...
    @push('scripts')
        <script>
            ...
            let filterState = {
                ...
                sortBy: $('#sort-by').val(),
                attributes: {} // for option/attribute filters
            };
            ...
            // 🔹 Update filters function (AJAX + URL sync)
            function updateFilters() {
                ...
                // Properly send each attribute as an array
                ...
                // Build query string with deep serialization
                ...
                subcategory=mobile-accessories&sortBy=&attributes%5Bsize%5D%5B%5D=S
