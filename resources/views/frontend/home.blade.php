    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-6 h-auto lg:h-[450px]">
        <div class="lg:col-span-3 relative rounded-2xl overflow-hidden shadow-lg group">
            ...
            <div class="absolute inset-0 flex flex-col justify-center px-8 lg:px-16 z-20 bg-gradient-to-r from-black/60 to-transparent">
                ...
                <a href="shop.html" class="w-fit bg-primary-600 hover:bg-primary-700 text-white px-8 py-3 rounded-full font-semibold transition shadow-lg shadow-primary-500/50 flex items-center gap-2">
        ...
        <div class="hidden lg:flex flex-col gap-6 h-full">
            <div class="relative rounded-2xl overflow-hidden h-1/2 shadow-md group">
                ...
                <div class="absolute inset-0 bg-black/30 p-6 flex flex-col justify-end">
                    ...
                    <a href="shop.html" class="text-primary-400 text-sm font-semibold hover:underline mt-1">Discover <i class="fas fa-angle-right"></i></a>
                </div>
            </div>
            <div class="relative rounded-2xl overflow-hidden h-1/2 shadow-md group">
                ...
                <div class="absolute inset-0 bg-black/30 p-6 flex flex-col justify-end">
                    ...
                    <a href="shop.html" class="text-primary-400 text-sm font-semibold hover:underline mt-1">Shop Now <i class="fas fa-angle-right"></i></a>
                </div>
            </div>
        </div>
    </div>
...
<section class="py-8">
    ...
    <div class="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-8 gap-4">
        ...
        <a href="{{ route('category.details',$category->slug) }}" class="group flex flex-col items-center gap-3 p-4 bg-white rounded-xl shadow-sm border border-transparent hover:border-primary-200 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
            ...
            <span class="text-xs font-semibold text-gray-700 text-center group-hover:text-primary-600">{{ $category->name }}</span>
        </a>
        @endforeach
    </div>
</section>
...
<section class="py-4">
    <div class="relative rounded-2xl overflow-hidden shadow-lg h-40 md:h-64 flex items-center bg-gray-900">
        ...
        <div class="relative z-10 p-8 md:pl-16">
            <span class="text-yellow-400 font-bold tracking-widest text-sm uppercase mb-2 block">Pohela Boishakh Special</span>
            <h2 class="text-3xl md:text-5xl font-extrabold text-white mb-4">Flat 50% Discount <br>On Traditional Wear</h2>
            <a href="shop.html" class="bg-white text-gray-900 px-6 py-2.5 rounded-lg font-bold hover:bg-primary-500 hover:text-white transition shadow-lg">Check Offers</a>
        </div>
    </div>
</section>
...
<section class="py-8">
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
        ...
        <div class="bg-white rounded-xl border border-gray-100 hover:border-primary-500 hover:shadow-2xl transition-all duration-300 group overflow-hidden flex flex-col h-full relative">
            <div class="relative h-48 w-full bg-gray-50 p-4 flex items-center justify-center overflow-hidden">
                <img src="{{ $product->imageUrl }}" class="max-h-full object-contain hover:scale-105 transition duration-500 mix-blend-multiply z-0">
    ...
    <div class="text-center mt-10">
        <a href="shop.html" class="bg-white border-2 border-gray-200 text-gray-700 font-bold py-3 px-8 rounded-full hover:border-primary-500 hover:text-primary-600 transition inline-block">Load More Products</a>
    </div>
</section>
