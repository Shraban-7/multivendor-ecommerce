...
@section('content')
        ...
        <div @click.away="quickViewOpen = false"
            ...
            <div class="w-full md:w-1/2 bg-gray-100 flex items-center justify-center p-4 relative">
                <button @click="quickViewOpen = false"
                    class="absolute top-4 left-4 md:hidden w-8 h-8 flex items-center justify-center bg-white rounded-full shadow"><i
            ...
            <div class="w-full md:w-1/2 p-6 md:p-8 flex flex-col overflow-y-auto">
                <div class="flex justify-between items-start">
                    ...
                    <button @click="quickViewOpen = false"
                        class="hidden md:block text-gray-400 hover:text-red-500 text-xl"><i
                            class="fa-solid fa-times"></i></button>
                </div>
                ...
                <div class="mt-4 border-b border-gray-100 pb-4">
                    ...
                    <p class="text-gray-600 text-sm mt-3 leading-relaxed">
                        Authentic premium running shoes designed for maximum comfort and durability. Perfect for daily wear
                        or sports activities. Imported directly.
                    </p>
                </div>
            ...
            <div class="hidden lg:flex flex-col gap-6 h-full">
                <div class="relative rounded-2xl overflow-hidden h-1/2 shadow-md group">
                    ...
                    <div class="absolute inset-0 bg-black/30 p-6 flex flex-col justify-end">
                        ...
                        <a href="#" class="text-primary-400 text-sm font-semibold hover:underline mt-1">Discover <i
                ...
                <div class="relative rounded-2xl overflow-hidden h-1/2 shadow-md group">
                    ...
                    <div class="absolute inset-0 bg-black/30 p-6 flex flex-col justify-end">
                        ...
                        <a href="#" class="text-primary-400 text-sm font-semibold hover:underline mt-1">Shop Now <i
                                class="fas fa-angle-right"></i></a>
                    </div>
                </div>
            </div>
    ...
    <section class="container mx-auto px-4 py-8">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
            ...
            <div class="flex items-center gap-4 p-2">
                <div class="bg-purple-50 w-12 h-12 rounded-full flex items-center justify-center text-purple-600 text-xl">
    ...
    <section class="container mx-auto px-4 py-8">
        <div class="flex justify-between items-end mb-6">
            ...
            <a href="#" class="text-sm font-medium text-primary-600 hover:text-primary-700">View All <i
                        ...
                        <div
                            ...
                            <div
                                ...
                                <button @click="quickViewOpen = true"
                                    class="w-9 h-9 bg-white text-gray-600 rounded-full shadow-lg flex items-center justify-center hover:bg-primary-600 hover:text-white transform translate-y-4 group-hover:translate-y-0 transition delay-75"><i
    ...
    <section class="container mx-auto px-4 py-4">
        <div class="relative rounded-2xl overflow-hidden shadow-lg h-40 md:h-64 flex items-center bg-gray-900">
            ...
            <div class="relative z-10 p-8 md:pl-16">
                <span class="text-yellow-400 font-bold tracking-widest text-sm uppercase mb-2 block">Black Friday
                    Special</span>
    ...
    <section class="container mx-auto px-4 py-8">
                ...
                <div
                    ...
                    <div class="relative h-48 w-full bg-gray-50 p-4 flex items-center justify-center overflow-hidden">
                        ...
                        <div
                            ...
                            <button @click="quickViewOpen = true"
                                class="bg-white text-gray-900 px-4 py-2 rounded-full text-xs font-bold hover:bg-primary-600 hover:text-white shadow-lg transform translate-y-4 group-hover:translate-y-0 transition-all duration-300">
        ...
        <div class="text-center mt-10">
            <button
                class="bg-white border-2 border-gray-200 text-gray-700 font-bold py-3 px-8 rounded-full hover:border-primary-500 hover:text-primary-600 transition">Load
    ...
    <section class="container mx-auto px-4 py-8 border-t border-gray-200">
        ...
        {{-- <div
            class="flex flex-wrap justify-center md:justify-between items-center gap-8 opacity-60 grayscale hover:grayscale-0 transition duration-500">
