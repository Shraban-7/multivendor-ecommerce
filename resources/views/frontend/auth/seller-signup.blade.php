                                ...
                                <div class="flex flex-col gap-4 sm:gap-5">
                                    ...
                                    <div class="form-ctrl space-y-2">
                                        ...
                                        <div id="profile_imageUpload"
                                            ...
                                            <div
                                                class="upload-placeholder flex flex-col items-center justify-center text-gray-500 pointer-events-none">
                                            ...
                                            <div id="profile_imagePreviewWrapper" class="hidden mt-4 relative z-10">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div class="form-ctrl space-y-2">
                                            ...
                                            <div id="nidFrontUpload"
                                                ...
                                                <!-- Preview Section -->
                                                <div id="nid_front_imagePreviewWrapper" class="hidden mt-4 relative z-10">
                                        ...
                                        <div class="form-ctrl space-y-2">
                                            ...
                                            <div id="nidBackUpload"
                                                ...
                                                <div id="nid_back_imagePreviewWrapper" class="hidden mt-4 relative z-10">
                                ...
                                <div class="flex flex-col gap-4 sm:gap-5">
                                    ...
                                    <div class="form-ctrl space-y-2">
                                        ...
                                        <div id="businessLogoUpload"
                                            ...
                                            <div id="business_logoPreviewWrapper" class="hidden mt-4 relative z-10">
                                ...
                                <div class="flex flex-col gap-4 sm:gap-5">
                                    ...
                                    <div class="form-ctrl space-y-2">
                                        ...
                                        <div id="tradeLicenseUpload"
                                            ...
                                            <div id="trade_license_imagePreviewWrapper" class="hidden mt-4 relative z-10">
                                    ...
                                    <div class="form-ctrl space-y-2">
                                        ...
                                        <div id="shopImageUpload"
                                            ...
                                            <div id="shop_imagePreviewWrapper" class="hidden mt-4 relative z-10">
        ...
        <script>
            $(document).ready(function() {
                ...
                $(document).on('click', '.remove-image-btn', function(e) {
                    e.stopPropagation(); // ⛔ Prevent click from bubbling to the parent container
