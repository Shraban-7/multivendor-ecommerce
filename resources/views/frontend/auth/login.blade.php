...
@section('content')
    ...
    <main class="flex-1 flex items-center justify-center p-4">
        <div
            class="bg-white rounded-2xl shadow-xl w-full max-w-4xl overflow-hidden flex flex-col md:flex-row h-full md:h-auto max-h-[800px]">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" name="email" placeholder="john@example.com"
                                class="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-200 focus:border-primary-500 focus:ring-2 focus:ring-primary-100 outline-none transition text-sm">
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="flex justify-between items-center mb-1">
                            ...
                            <a href="{{ route('password.forgot') }}"
                                class="text-xs text-primary-600 hover:text-primary-700 font-medium">Forgot Password?</a>
                        </div>
                        <div class="relative">
                            ...
                            <input type="password" name="password"
                                class="w-full pl-10 pr-12 py-3 rounded-lg border border-gray-200
               focus:border-primary-500 focus:ring-2 focus:ring-primary-100
               outline-none transition text-sm passwordInput"
                                id="passwordInput">

                            <button type="button"
                                class="absolute right-4 top-3.5 z-10 text-gray-400 hover:text-gray-600 cursor-pointer"
                    ...
                    <div class="flex items-center">
                        ...
                        <label for="remember" class="ml-2 block text-sm text-gray-600 cursor-pointer">Remember me for 30
                            days</label>
                    </div>

                    <!-- Submit Button -->
                    <button type="submit"
                        class="w-full bg-primary-600 text-white font-bold py-3 rounded-lg hover:bg-primary-700 transition shadow-lg shadow-primary-500/30">
                        Sign In
                    </button>
                </form>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <button
                        class="flex items-center justify-center gap-2 border border-gray-200 py-2.5 rounded-lg hover:bg-gray-50 transition text-sm font-medium text-gray-700">
            ...
            <div class="hidden md:block w-1/2 bg-gray-900 relative">
                <img src="https://images.unsplash.com/photo-1555529669-e69e7aa0ba9a?q=80&w=800&auto=format&fit=crop"
                    class="absolute inset-0 w-full h-full object-cover opacity-60">
                <div class="absolute inset-0 bg-gradient-to-t from-gray-900 via-transparent to-transparent"></div>

                <div class="absolute bottom-12 left-12 right-12 text-white">
                    <div class="w-12 h-1 bg-primary-500 mb-6 rounded-full"></div>
                    <h3 class="text-3xl font-bold mb-4 leading-tight">Shop the latest trends with <br> <span
                            class="text-primary-500">Confidence</span></h3>
                    <p class="text-gray-300 text-sm leading-relaxed">Join over 2 million customers enjoying the best
                        shopping experience in Bangladesh. Fast delivery, secure payment, and easy returns.</p>
                </div>
            </div>
        </div>
    </main>
