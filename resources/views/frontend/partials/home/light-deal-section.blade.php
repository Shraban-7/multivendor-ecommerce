        ...
        <div class="swiper lightDealsSwiper">
            <div class="swiper-wrapper">
                ...
                <div class="px-1 py-5 swiper-slide">
                    <a href="#" class="block w-full p-3 rounded-lg product-card hover:shadow-lg eq group">
                        ...
                        <div class="mt-2 space-y-1 card-content">
                            ...
                            <div class="flex flex-wrap items-center gap-2 time-progres">
                                ...
                                <span class="w-[35%] due-time text-sm inline-flex flex-no-wrap gap-1 items-center"><i
                                ...
                                <div class="lg:w-[45%] md:w-[50%] w-full md:px-2 xl:px-3">
                                    <div class="w-full space-y-2">
                                        ...
                                        <div
                                            ...
                                            <div class="flex items-center gap-2">
                                                <span class="pr-2 border-r border-gray-400 text-jet-gray">{{
                                                    number_shorten_format($product->stock_out) }}
                                                    sold</span>
                                        ...
                                        <div class="flex flex-wrap items-center gap-2">
                                            <div class="flex flex-no-wrap items-center gap-1 new-price">
                                                ...
                                                } elseif ($product->discount_type == \App\Enums\DiscountType::PERCENTAGE) {
                                                $price =
                                            ...
                                            <span class="text-xs px-2.5 py-0.5 rounded-lg border border-primary">-{{
                                                currency($product->discount_amount) }}
                                                last 2
                                                days</span>
