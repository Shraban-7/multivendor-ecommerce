<div class="group relative rounded-xl bg-white shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden">
    ...
    <div class="p-4 flex flex-col justify-between h-full">
        ...
        <div class="mt-4 flex items-center justify-between">
            ...
            @auth
            <div>
                <input type="hidden" name="quantity" id="qtyInput{{ $product['id'] }}"
                    class="qtyInputValue" value="">
                <button type="button"
                    data-id="{{ $product['id'] }}"
                    class="cartBtn w-9 h-9 flex items-center justify-center bg-primary hover:bg-theme-dark text-white text-sm rounded-full transition duration-200">
