{{-- <div class="relative overflow-hidden bg-white rounded-xl shadow-sm transition-all duration-300 hover:shadow-lg group">
    <div class="relative h-48 overflow-hidden bg-gray-50">
        <a href="{{ route('product.details', $product->slug) }}" class="block w-full h-full">
            ...
            <div class="absolute inset-0 bg-black bg-opacity-0 transition-opacity duration-300 group-hover:bg-opacity-5">
            </div>
        </a>
    </div>
    ...
    <div class="p-5">
        ...
        <div class="mt-4">
            ...
            <button data-id="{{ $product->id }}" type="button"
                ...
                <span class="flex items-center justify-center w-7 h-7 text-white bg-primary rounded-full">
                    <i class="fa-solid fa-cart-plus text-xs"></i>
                </span>
                <span class="font-medium text-gray-800">Add to Cart</span>
                <span class="flex items-center justify-center w-7 h-7 bg-gray-50 text-primary rounded-full">
