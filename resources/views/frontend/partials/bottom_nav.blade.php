<nav class="bg-[#F2F8FD] border-b">
        <div
          class="container flex flex-wrap md:flex-nowrap items-center justify-between md:justify-start relative"
        >
          <!-- All Departments -->
          <div class="group relative h-full py-5 flex">
            <!-- mega menu trigure btn -->
            <button
              class="flex items-center flex-no-wrap space-x-2 pr-5 text-persian-blue font-normal border-r border-butterfly-blue font-semibold text-base md:text-sm lg:text-base whitespace-nowrap"
            >
              <svg
                width="24"
                height="24"
              ...
              <div class="border border-[#E4E7E9] rounded w-full h-[31.2rem]">
                <ul class="py-4">
                  <li class="category-item">
                    <a
                      href="#"
                      class="block hover:bg-[#F2F4F5] px-4 py-2 hover:text-rangoon-green hover:font-semibold eq"
                  ...
                  >
                    ...
                    >
                      <ul
                        class="py-4 px-3 bg-white border border-[#E4E7E9] rounded ms-3 h-[31.2rem]"
                      >
                        <li class="brand-item">
                          <a
                            href="#"
                            class="block hover:bg-[#F2F4F5] px-4 py-2 hover:text-rangoon-green hover:font-semibold eq rounded-sm"
                            >All</a
                          >
                        </li>
                        <li class="brand-item">
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <!-- Product Cards -->
                              <div
                                class="feature-phones p-2 order-2 lg:order-1"
                              >
                                <h3
                                ...
                                <div class="feature-items-wrapper space-y-4">
                                  ...
                                  >
                                    <div class="item-image w-1/4">
                                      <a href="#" target="_blank">
                                        <img
                                          src="{{ asset('assets/frontend/images/feature-product-1.png') }}"
                                    ...
                                    <div
                                      class="item-details flex flex-col w-3/4"
                                    >
                                  ...
                                  >
                                    <div class="item-image w-1/4">
                                      <a href="#" target="_blank">
                                        <img
                                          src="{{ asset('assets/frontend/images/feature-product-2.png') }}"
                                  ...
                                  >
                                    <div class="item-image w-1/4">
                                      <a href="#" target="_blank">
                                        <img
                                          src="{{ asset('assets/frontend/images/feature-product-3.png') }}"
                                    ...
                                    >
                                      ...
                                      >
                                        <span
                                          class="line-through font-normal text-[#929FA5]"
                                          >$3200</span
                                        >
                                        $2,300
                                      </p>
                              ...
                              <div class="h-full discount-image order-1">
                                <a
                                  href="#"
                                  class="2xl:h-[29rem] block relative"
                                >
                                  <img
                                    src="{{ asset('assets/frontend/images/feature-product-4.png') }}"
                                    alt="Feature Phone"
          ...
          <!-- Nav Links -->
          <div
            class="nav-links hidden w-full md:block md:w-auto"
