    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden mb-5">
        <div class="bg-primary-100 px-4 py-3 border-b border-primary-200">
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    <img src="https://via.placeholder.com/30" alt="Vendor logo" class="h-8 w-8 rounded-full mr-3">
        ...
        <div class="divide-y divide-gray-100">
            ...
            <div class="p-4 flex items-start">
                <img src="https://via.placeholder.com/100" alt="Product image" class="w-16 h-16 rounded object-cover mr-4">
                <div class="flex-1 min-w-0">
                    <div class="flex justify-between items-start">
                        <h3 class="font-medium">Wireless Earbuds Pro</h3>
        ...
        <div class="md:col-span-2 bg-white rounded-lg shadow-sm p-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                <div>
                    ...
                    <p class="text-gray-900">John Doe<br>123 Main Street, Apt 4B<br>New York, NY 10001</p>
                </div>

                <div>
                    <h3 class="text-xs font-medium text-gray-500 mb-1">Delivery Method</h3>
                    <p class="text-gray-900">Standard Shipping</p>
                    <p class="text-gray-500 text-xs mt-1">Delivered on Sep 20, 2025</p>
                </div>
                ...
                <div>
                    ...
                    <p class="text-gray-900">johndoe@example.com<br>+1 (555) 123-4567</p>
                </div>
            </div>
    ...
    <div class="mt-8">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
            ...
            <div class="bg-white p-3 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                <img src="https://via.placeholder.com/150" alt="Product" class="w-full h-32 object-cover rounded-md mb-2">
