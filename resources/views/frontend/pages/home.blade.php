 ...
 <main class="home-page">
      ...
      <section class="hero-section flex flex-wrap lg:h-screen 2xl:h-[110vh]">
        <div class="w-full md:w-1/2 h-full">
          <a href="#">
            <img
              src="{{ asset('assets/frontend/images/hero-image-1.png') }}"
              alt="Image 1"
        ...
        <div class="w-full md:w-1/2 h-full">
          <div class="flex h-1/2">
            <div class="w-1/2">
              <a href="#">
                <img
                  src="{{ asset('assets/frontend/images/hero-image-2.png') }}"
                  alt="Image 2"
                  class="w-full h-full object-cover"
                />
              </a>
            ...
            <div class="w-1/2">
              <a href="#">
                <img
                  src="{{ asset('assets/frontend/images/hero-image-3.png') }}"
                  alt="Image 3"
                  class="w-full h-full object-cover"
                />
              </a>
          ...
          <div class="flex h-1/2">
            <div class="md:w-[45%] w-1/2">
              <a href="#">
                <img
                  src="{{ asset('assets/frontend/images/hero-image-4.png') }}"
                  alt="Image 4"
                  class="w-full h-full object-cover"
                />
              </a>
            ...
            <div class="md:w-[55%] w-1/2">
              <a href="#">
                <img
                  src="{{ asset('assets/frontend/images/hero-image-5.jpg') }}"
                  alt="Image 5"
                  class="w-full h-full object-cover"
                />
              </a>
      ...
      <section class="light-deals-section">
        ...
        <div class="section-promo-header bg-[#FF4F4F]">
          <div
            class="container flex items-center flex-col md:flex-row gap-3 md:gap-0 justify-between py-3 md:py-5"
          >
            <!-- star icon -->
            <span
              ><svg
            ...
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide py-5 px-1">
                ...
                >
                  <!-- slide image -->
                  <div
                    class="card-image h-[16.5rem] relative rounded-lg overflow-hidden"
                  >
                    <img
                      src="{{ asset('assets/frontend/images/light-deal-1.png') }}"
                      alt="Model wearing a jacket"
                      class="w-full h-full object-cover group-hover:scale-125 eq"
                    />
                    <span
                      class="block absolute bottom-9 left-1/2 -translate-x-1/2 bg-white px-4 py-3 rounded-full text-sm w-3/5 text-center"
                  ...
                  <div class="card-content mt-2 space-y-1">
                    ...
                    <div class="price-sold-amount flex items-center gap-2">
                      <h2 class="text-2xl font-bold text-primary">
                        ...
                        ></span>
                        <span class="align-middle text-xs text-[#ffa755]"
                          >$</span
                        >
                        25.00
                      </h2>
                    ...
                    <div class="time-progres flex items-center flex-wrap gap-2">
                      <div class="w-[60%] bg-gray-200 rounded-full h-2">
                        <div
                          class="progress bg-primary h-2 rounded-full"
                          style="width: 95%"
                        ></div>
                      </div>
                      <span
                        class="w-[35%] due-time text-sm inline-flex flex-no-wrap gap-1 items-center"
                        ><i class="fa-regular fa-clock"></i> 1:12:53.55</span
                      >
                    </div>
                    <!-- rating -->
              ...
              <div class="swiper-slide py-5 px-1">
                ...
                >
                  ...
                  >
                    <img
                      src="{{ asset('assets/frontend/images/light-deal-2.png') }}"
                  ...
                  <div class="card-content mt-2 space-y-1">
                    ...
                    <div class="time-progres flex items-center flex-wrap gap-2">
                      ...
                      <span
                        class="w-[35%] due-time text-sm inline-flex flex-no-wrap gap-1 items-center"
                        ><i class="fa-regular fa-clock"></i> 0:45:53.55</span
                      >
                    </div>
                    <!-- rating -->
                    <div class="flex items-center gap-2">
              ...
              <div class="swiper-slide py-5 px-1">
                ...
                >
                  ...
                  >
                    <img
                      src="{{ asset('assets/frontend/images/light-deal-3.png') }}"
                  ...
                  <div class="card-content mt-2 space-y-1">
                    ...
                    <div class="time-progres flex items-center flex-wrap gap-2">
                      ...
                      <span
                        class="w-[35%] due-time text-sm inline-flex flex-no-wrap gap-1 items-center"
                        ><i class="fa-regular fa-clock"></i> 18:13:45.12</span
                      >
                    </div>
                    <!-- rating -->
                    <div class="flex items-center gap-2">
              ...
              <div class="swiper-slide py-5 px-1">
                ...
                >
                  ...
                  >
                    <img
                      src="{{ asset('assets/frontend/images/light-deal-4.png') }}"
                  ...
                  <div class="card-content mt-2 space-y-1">
                    ...
                    <div class="time-progres flex items-center flex-wrap gap-2">
                      ...
                      <span
                        class="w-[35%] due-time text-sm inline-flex flex-no-wrap gap-1 items-center"
                        ><i class="fa-regular fa-clock"></i> 12:11:14.17</span
                      >
                    </div>
                    <!-- rating -->
                    <div class="flex items-center gap-2">
              ...
              <div class="swiper-slide py-5 px-1">
                ...
                >
                  ...
                  >
                    <img
                      src="{{ asset('assets/frontend/images/light-deal-5.png') }}"
                  ...
                  <div class="card-content mt-2 space-y-1">
                    ...
                    <div class="time-progres flex items-center flex-wrap gap-2">
                      ...
                      <span
                        class="w-[35%] due-time text-sm inline-flex flex-no-wrap gap-1 items-center"
                        ><i class="fa-regular fa-clock"></i> 0:50:13.45</span
                      >
                    </div>
                    <!-- rating -->
                    <div class="flex items-center gap-2">
      ...
      <section class="interest-section section-padding">
        <div class="container">
          ...
          <div class="sec-heading relative">
            ...
            <span class="inline-block absolute top-1/2 -translate-y-1/2 right-0"
              ><a href="#" class="theme-btn theme-outline-btn"
                >View All</a
              ></span
            >
          </div>
          ...
          <div class="swiper categoriesSwiper mt-10 md:mt-16">
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide group/categores eq">
                <a
                  href="#"
                  class="block product-card w-full flex flex-col items-center"
                >
                  <!-- slide image -->
                  <div
                    class="card-image lg:h-28 lg:w-28 md:w-24 md:h-24 w-16 h-16 relative"
                  >
                    <img
                      src="{{ asset('assets/frontend/images/category-1.png') }}"
                      alt="Grocery"
                  ...
                  <div class="card-content mt-3 lg:mt-5">
                    <a
                      href="#"
                      class="block text-black text-center group-hover/categores:text-light-yellow font-medium md:text-lg lg:text-xl text-sm eq"
                      >Grocery</a
                    >
                  </div>
                </a>
              ...
              <div class="swiper-slide group/categores eq">
                ...
                >
                  ...
                  >
                    <img
                      src="{{ asset('assets/frontend/images/category-2.png') }}"
                      alt="Home Appliances"
                      class="w-full h-full object-contain"
                    />
                  </div>
              ...
              <div class="swiper-slide group/categores eq">
                ...
                >
                  ...
                  >
                    <img
                      src="{{ asset('assets/frontend/images/category-3.png') }}"
                      alt="Fashion"
                      class="w-full h-full object-contain"
                    />
                  </div>
              ...
              <div class="swiper-slide group/categores eq">
                ...
                >
                  ...
                  >
                    <img
                      src="{{ asset('assets/frontend/images/category-4.png') }}"
                      alt="Electronics"
                      class="w-full h-full object-contain"
                    />
                  </div>
              ...
              <div class="swiper-slide group/categores eq">
                ...
                >
                  ...
                  >
                    <img
                      src="{{ asset('assets/frontend/images/category-5.png') }}"
                      alt="Beauty & Sallon"
                      class="w-full h-full object-contain"
                    />
                  </div>
              ...
              <div class="swiper-slide group/categores eq">
                ...
                >
                  ...
                  >
                    <img
                      src="{{ asset('assets/frontend/images/category-6.png') }}"
                      alt="Automotive & Tire"
                      class="w-full h-full object-contain"
                    />
                  </div>
          ...
          <div class="swiper fiveSlideSwiper mt-10 md:mt-20">
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide group/interest-pro-card eq">
                <div
                  class="block product-card w-full flex flex-col items-center p-2"
                >
                  <div
                    class="w-full bg-theme-light rounded-md hover:shadow-md eq overflow-hidden"
                  >
                    <div
                      class="item-img h-32 sm:h-40 md:h-52 px-10 pt-5 overflow-hidden"
                    >
                      <a href="#">
                        <img
                          class="w-full h-full object-contain"
                    ...
                    <div class="p-2 sm:p-4 space-y-1">
                      ...
                      >
                        <a href="#"
                          >Muffets & Tuffets Whole Wheat Bread 400 g</a
                        >
                      </h2>
                      <div class="rating-stars text-xs text-light-yellow">
                        <i class="fa-solid fa-star"></i>
                ...
                >
                  ...
                  >
                    ...
                    <div class="p-2 sm:p-4 space-y-1">
                      ...
                      >
                        <a href="#"
                          >Exclusive T-Shirt, Shirt, & Gavadin Pant Combo
                          offer</a
                        >
                      </h2>
                      <div class="rating-stars text-xs text-light-yellow">
              ...
              <div class="swiper-slide group/interest-pro-card eq">
                ...
                >
                  ...
                  >
                    <div
                      class="item-img h-32 sm:h-36 md:h-52 px-10 pt-5 overflow-hidden"
                    >
                      <a href="#">
                        <img
                          class="w-full h-full object-contain"
      ...
      <section class="feature-gallery">
        <div
          class="container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-3 md:gap-4"
        >
          <!-- col 1 -->
          <div class="relative lg:col-span-2 lg:row-span-2 lg:h-[33rem] h-96">
            <div class="relative group overflow-hidden rounded-xl h-full">
              <div class="w-full h-full">
                <!-- gallery image -->
                <img
                  src="{{ asset('assets/frontend/images/gallery-feature-pro-1.png') }}"
                  alt="Slow cooker with ingredients"
                  class="w-full h-full object-cover"
                />
              </div>
              <!-- overlay -->
              <div
                class="absolute inset-0 bg-black/30 eq group-hover:bg-black/50"
              ></div>
              <!-- content -->
              <div
              ...
              >
                ...
                <h2
                  class="text-2xl md:text-4xl xl:text-5xl font-semibold !leading-[1.2]"
                >
          ...
          <!-- col 2 -->
          <div
            class="relative lg:col-span-2 lg:h-[33rem] overflow-hidden flex flex-col gap-4"
          >
            <!-- row 1 -->
            <div class="relative group overflow-hidden rounded-xl h-1/2">
              ...
              <div class="w-full h-full">
                <img
                  src="{{ asset('assets/frontend/images/gallery-feature-pro-2.png') }}"
                  alt="Coats and jackets collection"
                  class="w-full h-full object-cover"
                />
              </div>
              <!-- overlay -->
              ...
              >
                ...
                <h2
                  class="text-2xl md:text-3xl xl:text-4xl font-semibold !leading-[1.2]"
                >
                  Beat The Chill
                </h2>
                <button
            ...
            <div class="h-1/2 grid grid-cols-2 gap-2">
              <div class="relative group overflow-hidden rounded-xl h-full">
                ...
                <div class="w-full h-full">
                  <img
                    src="{{ asset('assets/frontend/images/gallery-feature-pro-3.png') }}"
                ...
                <div class="absolute top-0 left-0 w-full h-full p-6 text-white">
                  <h2
                    class="text-xl md:text-lg xl:text-[1.7rem] font-medium mb-2 sm:mb-4 !leading-[1.2]"
                  >
                    Festive decor in everywhere
                  </h2>
                  <a
                    href="#"
                    class="text-white underline font-medium hover:text-primary eq"
                    >Shop Now</a
                  >
                </div>
              </div>
              ...
              <div class="relative group overflow-hidden rounded-xl h-full">
                ...
                <div class="w-full h-full">
                  <img
                    src="{{ asset('assets/frontend/images/gallery-feature-pro-4.png') }}"
          ...
          <!-- col 3 -->
          <div
            class="lg:row-span-2 lg:h-[33rem] md:col-span-2 lg:col-span-1 h-96"
          >
            <div class="relative group overflow-hidden rounded-xl h-full">
              <!-- gallery image -->
              <div class="w-full lg:h-full">
                <img
                  src="{{ asset('assets/frontend/images/gallery-feature-pro-5.png') }}"
                  alt="Fashion collection"
                  class="w-full h-full lg:h-full object-cover"
                />
              </div>
              <!-- overlay -->
              <div
              ...
              >
                <h2
                  class="text-xl md:text-lg xl:text-2xl font-medium mb-2 sm:mb-4 !leading-[1.2]"
                >
      ...
      <section class="promo-sec bg-light-yellow my-5">
        <div
          class="container flex items-center flex-col md:flex-row gap-2 md:gap-5 justify-center py-4 md:py-6"
        >
          <!-- promo title -->
      ...
      <section class="new-arrivals-section section-padding">
        <div class="container">
          ...
          <div class="sec-heading relative">
            <h2
              class="font-semibold sm:text-xl xl:text-4xl lg:text-3xl md:text-2xl uppercase text-theme-dark"
            >
              New Arrivals
            </h2>
            ...
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide group/new-arriv-pro-card eq">
                ...
                >
                  ...
                  >
                    <div
                      class="item-img h-32 sm:h-40 md:h-52 pt-5 overflow-hidden"
                    >
                      <a href="#">
                        <img
                          class="w-full h-full object-contain"
                    ...
                    <div class="item-info p-2 sm:p-4 space-y-1">
                      <div
                        class="rating-stars sm:text-sm text-xs text-light-yellow"
                      >
                        <i class="fa-solid fa-star"></i>
                        <i class="fa-solid fa-star"></i>
                        <i class="fa-solid fa-star"></i>
          ...
          <div
            class="promo-trending-products flex flex-col lg:flex-row gap-5 mt-10"
          >
            <div
              class="trend-prods flex w-full sm:flex-row flex-col gap-5 lg:w-7/12 sm:h-96"
            >
              <!-- seller -->
              ...
              <!-- trending -->
              <div
                class="products h-auto sm:h-full sm:w-1/2 w-full bg-[#F8F8F8] rounded-lg"
              >
                <!-- Product Cards -->
                <div class="trending-phones p-5">
                  <h3
                    class="text-lg text-rangoon-green font-semibold mb-4 capitalize"
                  >
                    Trending Products
                  ...
                  <div class="trending-items-wrapper space-y-4">
                    ...
                    >
                      <div class="item-image w-1/4">
                        <a href="#" target="_blank">
                          <img
                            src="{{ asset('assets/frontend/images/trend-prod-1.png') }}"
                      ...
                      <div
                        class="item-details flex flex-col gap-2 w-3/4 text-xs"
                      >
                        <h4>
                          <a
                            href="#"
                    ...
                    >
                      <div class="item-image w-1/4">
                        <a href="#" target="_blank">
                          <img
                            src="{{ asset('assets/frontend/images/trend-prod-2.png') }}"
                    ...
                    >
                      <div class="item-image w-1/4">
                        <a href="#" target="_blank">
                          <img
                            src="{{ asset('assets/frontend/images/trend-prod-3.png') }}"
            ...
            <div class="promotional-poster w-full lg:w-5/12 sm:h-96 h-auto">
              <div class="promo-img h-full w-full rounded-2xl overflow-hidden">
                <a href="#">
                  <img
                    src="{{ asset('assets/frontend/images/promo-fifty.png') }}"
      ...
      <section class="thumbnail-gallery">
        ...
        >
          <!-- col 1 -->
          <div class="relative lg:col-span-2 lg:row-span-2 md:h-[33rem] h-96">
            <div class="relative group overflow-hidden rounded-xl h-full">
              <div class="w-full h-full">
                <!-- promotion image -->
                <a href="#">
                  <img
                    src="{{ asset('assets/frontend/images/sessional-promo-1.png') }}"
                    alt="Halloween Babyes Enjoying"
                    class="w-full h-full object-cover"
                  />
                </a>
              </div>
          ...
          >
            ...
            <div class="relative group overflow-hidden rounded-xl h-1/2">
              ...
              <div class="w-full h-full">
                <a href="#">
                  <img
                    src="{{ asset('assets/frontend/images/sessional-promo-2.jpg') }}"
                    alt="Yammi Halloween Foods"
                    class="w-full h-full object-cover"
                  />
                </a>
              </div>
            ...
            <div class="h-1/2 grid grid-cols-2 gap-2">
              <div class="relative group overflow-hidden rounded-xl h-full">
                ...
                <div class="w-full h-full">
                  <a href="#">
                    <img
                      src="{{ asset('assets/frontend/images/sessional-promo-3.jpg') }}"
                      alt="Cute Halloween Dols"
                      class="w-full h-full object-cover"
                    />
                  </a>
                </div>
              ...
              <div class="relative group overflow-hidden rounded-xl h-full">
                ...
                <div class="w-full h-full">
                  <a href="#">
                    <img
                      src="{{ asset('assets/frontend/images/sessional-promo-4.png') }}"
                      alt="Halloween couple with neon light musk"
                      class="w-full h-full object-cover"
                    />
                  </a>
                </div>
          ...
          >
            <div class="relative group overflow-hidden rounded-xl h-full">
              ...
              <div class="w-full h-full">
                <a href="#">
                  <img
                    src="{{ asset('assets/frontend/images/sessional-promo-5.jpeg') }}"
                    alt="Cute & Healthy baby with halloween orange Dress"
                    class="w-full h-full object-cover"
                  />
                </a>
              </div>
          ...
          <div class="swiper featuredVideoSwiper mt-5 md:mt-10">
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide group/featured-videos-pro-card py-3 eq">
                ...
                >
                  <div
                    class="relative w-full sm:h-[30rem] h-96 overflow-hidden"
                  >
                    <video
                      class="w-full h-full object-cover cursor-pointer"
                      poster="{{ asset('assets/frontend/images/featured-video-thumb-1.png') }}"
                      muted
                      loop
                    >
                      <source
                        src="{{ asset('assets/frontend/videos/video-product-1.mp4') }}"
                        type="video/mp4"
                      />
                    </video>
                    <div
                      class="absolute bottom-3 sm:bottom-5 left-3 sm:left-5 md:left-8 w-1/3"
                    >
                      <a
                        href="#"
                        class="text-white w-full block truncate font-light hover:text-light-yellow eq"
                        >@jesikaperker07854</a
                      >
                    </div>
                    <div
                  ...
                  <div class="py-4 px-2 sm:px-3 md:px-6 flex items-start gap-3">
                    <div class="w-15 h-15 overflow-hidden">
                      <a href="#">
                        <img
                          src="{{ asset('assets/frontend/images/video-prod-small-1.png') }}"
              ...
              <div class="swiper-slide group/featured-videos-pro-card py-3 eq">
                ...
                >
                  ...
                  >
                    <video
                      class="w-full h-full object-cover cursor-pointer"
                      poster="{{ asset('assets/frontend/images/featured-video-thumb-2.png') }}"
                      muted
                      loop
                    >
                      <source
                        src="{{ asset('assets/frontend/videos/video-product-2.mp4') }}"
                        type="video/mp4"
                      />
                    </video>
                    <div
                  ...
                  <div class="py-4 px-2 sm:px-3 md:px-6 flex items-start gap-3">
                    <div class="w-15 h-15 overflow-hidden">
                      <a href="#">
                        <img
                          src="{{ asset('assets/frontend/images/video-prod-small-2.png') }}"
              ...
              <div class="swiper-slide group/featured-videos-pro-card py-3 eq">
                ...
                >
                  ...
                  >
                    <video
                      class="w-full h-full object-cover cursor-pointer"
                      poster="{{ asset('assets/frontend/images/featured-video-thumb-3.png') }}"
                      muted
                      loop
                    >
                      <source
                        src="{{ asset('assets/frontend/videos/video-product-3.mp4') }}"
                        type="video/mp4"
                      />
                    </video>
                    <div
                  ...
                  <div class="py-4 px-2 sm:px-3 md:px-6 flex items-start gap-3">
                    <div class="w-15 h-15 overflow-hidden">
                      <a href="#">
                        <img
                          src="{{ asset('assets/frontend/images/video-prod-small-3.png') }}"
