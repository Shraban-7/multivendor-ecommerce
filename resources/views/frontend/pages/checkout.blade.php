...
<div>
    <form
        id="checkout-form"
        class="container mx-auto grid gap-6 lg:grid-cols-3 text-gray-800">
        <!-- Left Section -->
        <div class="lg:col-span-2 space-y-6">
            <!-- Billing Information Box -->
            <section
                class="bg-white rounded-lg border border-gray-100 p-6 shadow-sm space-y-5">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <button
                        type="button"
                        data-modal-target="add-billing-address-modal"
                ...
                <div
                    class="max-h-[18rem] overflow-y-auto space-y-2 scrollbar-thin scrollbar-thumb-gray-300">
                    ...
                    <label
                        ...
                        <div class="flex-1 space-y-0.5">
                            <div
                                class="font-medium text-gray-900 flex justify-between items-center">
                                <span>
        ...
        <aside class="space-y-5">
            <div class="bg-white rounded-lg border border-gray-100 p-6 shadow-sm">
                ...
                <div
                    class="flex justify-between items-center text-base font-semibold mb-2">
                ...
                <div class="mt-5">
                    ...
                    <div
                        class="grid grid-cols-2 sm:grid-cols-3 gap-3 justify-items-start">
                ...
                <button
                    ...
                    type="button"
                    data-seller-id="{{ $selectedSellerId }}"
            ...
            <!-- Trust Section -->
            <div
                class="bg-white border border-gray-100 rounded-lg p-5 shadow-sm text-xs text-gray-600">
                ...
                <div
                    class="flex items-center justify-between gap-6 border-t border-gray-100 pt-4">
                    @foreach (payment_options() as $option)
                    <img
                        src="{{ storage_url($option->image) }}"
                        alt="{{ $option->name }}"
...
<script>
    $(document).ready(function() {
        $('#continue-payment-btn').click(function(e) {
            ...
            console.log('Form data:', $('#checkout-form').serialize());
