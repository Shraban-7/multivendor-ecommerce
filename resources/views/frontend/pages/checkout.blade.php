                ...
                <section class="bg-white p-6 sm:p-8 rounded-2xl shadow-soft border border-gray-100">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                        ...
                        <label class="relative block cursor-pointer group">
                            <input type="radio" name="address" class="peer sr-only" checked>
                            <div class="p-5 rounded-xl border-2 border-primary-100 bg-primary-50 peer-checked:border-primary-500 peer-checked:bg-white relative transition-all duration-200">
                                <div class="absolute top-4 right-4 text-primary-600 opacity-0 peer-checked:opacity-100">
                                    <i data-lucide="check-circle-2" class="w-6 h-6 fill-primary-100"></i>
                                </div>
                                <div class="flex items-center gap-2 mb-2">
                                    <span class="px-2 py-1 rounded-md bg-white border border-gray-200 text-xs font-bold text-gray-700 uppercase tracking-wide">Home</span>
                                </div>
                                <h3 class="font-bold text-gray-900 text-sm">Rafiqul Islam</h3>
                                <p class="text-sm text-gray-500 mt-1 leading-relaxed">House 45, Road 12, Block C,<br>Banani, Dhaka - 1213</p>
                                <p class="text-sm text-gray-900 font-medium mt-2">+880 1712-345678</p>
                            </div>
                        </label>
                        ...
                        <label class="relative block cursor-pointer group">
                            ...
                            <div class="p-5 rounded-xl border border-gray-200 bg-white hover:border-gray-300 peer-checked:border-primary-500 peer-checked:ring-1 peer-checked:ring-primary-500 relative transition-all duration-200">
                                <div class="absolute top-4 right-4 text-primary-600 opacity-0 peer-checked:opacity-100">
                                    <i data-lucide="check-circle-2" class="w-6 h-6"></i>
                                </div>
                                <div class="flex items-center gap-2 mb-2">
                                    <span class="px-2 py-1 rounded-md bg-gray-100 text-xs font-bold text-gray-600 uppercase tracking-wide">Office</span>
                                </div>
                                <h3 class="font-bold text-gray-900 text-sm">Rafiqul (Work)</h3>
                                <p class="text-sm text-gray-500 mt-1 leading-relaxed">Level 12, ABC Tower,<br>Gulshan 2, Dhaka - 1212</p>
                                <p class="text-sm text-gray-900 font-medium mt-2">+880 1912-345678</p>
                            </div>
                        </label>
                    </div>
                </section>
        ...
        <aside class="space-y-5">
            ...
            <div class="mt-5">
                ...
                <div class="space-y-3 mb-4">
                    <!-- bKash -->
                    <label class="group relative flex items-center p-4 border rounded-xl cursor-pointer hover:bg-gray-50 transition-all duration-200 has-[:checked]:border-primary-500 has-[:checked]:bg-primary-50/30 has-[:checked]:shadow-sm">
                        <input name="payment" type="radio" class="h-5 w-5 text-primary-600 border-gray-300 focus:ring-primary-500" checked>
                        <div class="ml-4 flex-1">
                            <div class="flex items-center justify-between">
                                <span class="block text-sm font-bold text-gray-900 group-has-[:checked]:text-primary-700">bKash Payment</span>
                                <img src="https://freepnglogo.com/images/all_img/1701670291bkash-app-logo-png.png" alt="bKash" class="h-8 w-auto object-contain">
                            </div>
                            <span class="block text-xs text-gray-500 mt-0.5">Pay securely using your bKash wallet</span>
                        </div>
                    </label>

                    <!-- COD -->
                    <label class="group relative flex items-center p-4 border rounded-xl cursor-pointer hover:bg-gray-50 transition-all duration-200 has-[:checked]:border-primary-500 has-[:checked]:bg-primary-50/30 has-[:checked]:shadow-sm">
                        <input name="payment" type="radio" class="h-5 w-5 text-primary-600 border-gray-300 focus:ring-primary-500">
                        <div class="ml-4 flex-1">
                            <div class="flex items-center justify-between">
                                <span class="block text-sm font-bold text-gray-900 group-has-[:checked]:text-primary-700">Cash on Delivery</span>
                                <div class="p-1.5 bg-gray-100 rounded text-gray-500">
                                    <i data-lucide="banknote" class="w-5 h-5"></i>
                                </div>
                            </div>
                            <span class="block text-xs text-gray-500 mt-0.5">Pay only when you receive your order</span>
                        </div>
                    </label>
                </div>
    ...
    $(document).ready(function() {
        ...
        $('.division-select').each(function() {
            ...
            if (typeof addressId !== 'undefined' && addressId) {
                selectedDistrictId = "{{ old('district_id.' . ($address->id ?? ''), $address->district_id ?? '') }}";
            } else {
