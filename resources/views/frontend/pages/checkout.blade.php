...
@section('content')
   <main class="cart-details-page pb-5 sm:pb-10">
      ...
      <section class="checkout-section container section-padding">
        <form
          action="./orderSuccess.html"
          class="block grid gap-5 xl:gap-10 2xl:gap-20 lg:grid-cols-3"
        >
          <!-- Billing information -->
            ...
            <div class="space-y-6 text-theme-dark">
              ...
              <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <!-- Company Name -->
                  <div class="space-y-2">
                    <label for="company-name" class="block text-sm"
                      >Company Name
                ...
                <!-- Location Details -->
                <div
                  class="grid grid-cols-1 xsm:grid-cols-2 md:grid-cols-4 gap-4"
                >
                  <div class="space-y-2">
                  ...
                  <div class="space-y-2">
                    <label class="block text-sm" for="region/state"
                      >Region/State</label
                    >
                    <select
                      required
                ...
                <div class="flex items-center">
                  ...
                  />
                  <label for="diff-addr" class="ml-2 text-sm"
              ...
              <div class="flex flex-col gap-y-4 !my-6 md:!my-10 border py-5">
                ...
                >
                  ...
                  >
                    ...
                    ></span>
                    <span
                      class="font-medium text-sm whitespace-nowrap group-hover:text-primary eq"
                  ...
                  >
                    <img
                      src="{{ asset('assets/frontend/images/payment-option-1.png') }}"
                      alt="Venmo Payment"
                  ...
                  >
                    <img
                      src="{{ asset('assets/frontend/images/payment-option-2.png') }}"
                      alt="PayPal Payment"
                      class="h-6 sm:h-7 w-auto"
                    />
                    <span
                  ...
                  >
                    <img
                      src="{{ asset('assets/frontend/images/payment-option-3.png') }}"
                      alt="Amazon Payment"
                      class="h-6 sm:h-7 w-auto"
                    />
                    <span
                ...
                <div class="flex flex-col gap-y-4 md:p-5 p-4">
                  <div class="space-y-2">
                    <label class="block text-sm" for="name-on-card"
                      >Name on Card</label
                    >
                    <input
                      required
                  ...
                  <div class="space-y-2">
                    <label class="block text-sm" for="card-number"
                      >Card Number</label
                    >
                    <input
                      required
                  ...
                  <div class="grid grid-cols-2 gap-4">
                    <div class="space-y-2">
                      <label class="block text-sm" for="expire-date"
                        >Expire Date</label
                      >
                      <input
                        required
              ...
              <div class="space-y-4">
                ...
                <div class="space-y-2">
                  <label class="block text-sm" for="order-notes"
                    >Order Notes
                    <span class="text-jet-gray">(Optional)</span></label
                  >
                  <textarea
                    ...
                    class="w-full px-4 py-2 border border-gray-300 rounded focus:ring-[1] focus:ring-light-yellow focus:border-light-yellow h-24 text-sm md:text-base"
                  ></textarea>
                </div>
              </div>
            </div>
              ...
              <div class="text-davy-gray p-3 sm:p-4 protect-card-info">
                ...
                >
                  ...
                  <svg
                    width="22"
                    height="26"
                    class="text-leaf-green w-6 h-6 sm:w-8 sm:h-8"
                    viewBox="0 0 22 26"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                  >
                ...
                <!-- protect card info -->
                <ul
                  class="pl-2 text-xs list-disc list-inside flex flex-col gap-2 mt-2 sm:mt-3"
                >
                  <li class="inline-flex items-start gap-2">
                    <i
                      class="fa-solid fa-check text-base sm:text-lg text-leaf-green"
                    ></i>
                    <span
                      >Temu follows the Payment Card Industry Data Security
                ...
                <div class="flex flex-wrap gap-x-2 gap-y-1 mt-5">
                  <img
                    src="{{ asset('assets/frontend/images/cart-payment-method-1.png') }}"
                    alt="Visa card"
                    class="w-auto h-8 sm:h-10 border rounded"
                  />
                  <img
                    src="{{ asset('assets/frontend/images/cart-payment-method-2.png') }}"
                    alt="mastercard"
                    class="w-auto h-8 sm:h-10 border rounded"
                  />
                  <img
                    src="{{ asset('assets/frontend/images/cart-payment-method-3.png') }}"
                    alt="American Express"
                    class="w-auto h-8 sm:h-10 border rounded"
                  />
                  <img
                    src="{{ asset('assets/frontend/images/cart-payment-method-4.png') }}"
                    alt="Discover"
                    class="w-auto h-8 sm:h-10 border rounded"
                  />
                  <img
                    src="{{ asset('assets/frontend/images/cart-payment-method-5.png') }}"
                    alt="Paypal"
                    class="w-auto h-8 sm:h-10 border rounded"
                  />
                  <img
                    src="{{ asset('assets/frontend/images/cart-payment-method-6.png') }}"
                    alt="Apple Pay"
                    class="w-auto h-8 sm:h-10 border rounded"
                  />
                  <img
                    src="{{ asset('assets/frontend/images/cart-payment-method-7.png') }}"
                    alt="G Pay"
                    class="w-auto h-8 sm:h-10 border rounded"
                  />
                </div>
