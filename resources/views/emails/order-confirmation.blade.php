                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="600"
                    ...
                    <tr>
                        <td style="padding:32px 40px 0;text-align:center;">
                            <div
                                style="display:inline-block;padding:8px 20px;background-color:#E8F5E9;border-radius:20px;">
                    ...
                    <tr>
                        <td style="padding:24px 40px 32px;">
                            ...
                            <p style="margin:0 0 24px;color:#5A6C7D;font-size:15px;text-align:center;">Your order has
                                been confirmed and is being processed.</p>
                                        ...
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0"
                                            ...
                                            <tr>
                                                ...
                                                <td align="right" style="padding:4px 0;">
                                                    <strong
                                                        style="color:#2C3E50;font-size:14px;">#{{ $order_id }}</strong>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding:4px 0;">
                                                ...
                                                <td align="right" style="padding:4px 0;">
                                                    <strong
                                                        style="color:#2C3E50;font-size:14px;">{{ $order_date }}</strong>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding:4px 0;">
                                                ...
                                                <td align="right" style="padding:4px 0;">
                                                    <strong
                                                        style="color:#FF6B35;font-size:16px;">{{ $total_amount }}</strong>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
                                ...
                                <tr>
                                    ...
                                    <td valign="top">
                                        <p style="margin:0 0 4px;color:#2C3E50;font-size:15px;font-weight:600;">
                                            {{ $product_name_1 }}</p>
                                        <p style="margin:0 0 8px;color:#5A6C7D;font-size:13px;">Vendor:
                                            {{ $vendor_name_1 }}</p>
                                        <p style="margin:0;color:#5A6C7D;font-size:13px;">Qty: {{ $quantity_1 }} ×
                                            {{ $price_1 }}</p>
                                    </td>
                            ...
                            <!-- Price Summary -->
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
                                style="margin:24px 0 32px;padding-top:16px;border-top:1px solid #E0E6ED;">
                                <tr>
                            ...
                            <!-- Shipping Address -->
                            <h3 style="margin:0 0 12px;color:#2C3E50;font-size:16px;font-weight:600;">Shipping Address
                            </h3>
                    ...
                    <tr>
                        <td style="padding:24px 40px;background-color:#F7F9FC;border-top:1px solid #E0E6ED;">
                            <p style="margin:0 0 12px;color:#5A6C7D;font-size:13px;line-height:1.5;text-align:center;">
                                Questions about your order? Contact us at <a href="mailto:{{ config('mail.support_address') }}"
