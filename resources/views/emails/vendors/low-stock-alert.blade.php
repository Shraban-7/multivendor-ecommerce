...
@section('content')
    ...
    <tr>
        <td style="padding:32px 40px 0;text-align:center;">
            <div
                style="display:inline-block;width:64px;height:64px;background-color:#FFF3E0;border-radius:50%;line-height:64px;">
    ...
    <tr>
        <td style="padding:24px 40px 32px;">
            ...
            <p style="margin:0 0 24px;color:#5A6C7D;font-size:15px;text-align:center;">Some of your products are running low
                on inventory.</p>

            <!-- Alert Message -->
            <div
                style="padding:16px;background-color:#FFF3E0;border-left:4px solid #FF9800;border-radius:6px;margin-bottom:24px;">
                <p style="margin:0;color:#5A6C7D;font-size:14px;line-height:1.6;">Update your inventory soon to avoid
                    missing out on sales. Products with zero stock are automatically hidden from customers.</p>
            </div>
            ...
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
                style="margin:0 0 12px;padding:16px;background-color:#F7F9FC;border-radius:6px;">
                <tr>
                    <td width="60" style="padding-right:12px;" valign="top">
                        <img src="{{ $product_image_1 }}" alt="{{ $product_name_1 }}"
            ...
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
                ...
                <tr>
                    <td width="60" style="padding-right:12px;" valign="top">
                        <img src="{{ $product_image_2 }}" alt="{{ $product_name_2 }}"
                            style="width:60px;height:60px;object-fit:cover;border-radius:6px;display:block;">
                    </td>
                    <td valign="top">
            ...
            <p style="margin:0 0 32px;color:#5A6C7D;font-size:13px;text-align:center;">+ {{ $additional_count }} more
                products</p>
            ...
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                <tr>
                    <td align="center" style="padding-bottom:12px;">
                        <a href="{{ $update_inventory_url }}"
                            style="display:inline-block;padding:14px 32px;background-color:#FF6B35;color:#ffffff;text-decoration:none;border-radius:6px;font-weight:600;font-size:16px;box-shadow:0 4px 12px rgba(255,107,53,0.3);">Update
                            Inventory</a>
                    </td>
                </tr>
                <tr>
                    <td align="center">
                        <a href="{{ $view_all_products_url }}"
