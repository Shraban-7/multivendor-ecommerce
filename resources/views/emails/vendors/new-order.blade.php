...
@section('content')
    ...
    <tr>
        <td style="padding:24px 40px 32px;">
            <h2 style="margin:0 0 8px;color:#2C3E50;font-size:24px;font-weight:600;text-align:center;">You Have a New
                Order!</h2>
            <p style="margin:0 0 24px;color:#5A6C7D;font-size:15px;text-align:center;">A customer has placed an order from
                your store.</p>

            <!-- Order Summary -->
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
                style="margin:0 0 24px;border:2px solid #FF6B35;border-radius:8px;overflow:hidden;">
                <tr>
            ...
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
                ...
                <tr>
                    ...
                    <td valign="top">
                        <p style="margin:0 0 4px;color:#2C3E50;font-size:15px;font-weight:600;">{{ $product_name }}</p <p
                            style="margin:0 0 4px;color:#2C3E50;font-size:15px;font-weight:600;">{{ $product_name }}</p>
            ...
            <div
                style="padding:16px;background-color:#FFF4F0;border-radius:6px;border-left:4px solid #FF6B35;margin-bottom:32px;">
            ...
            <div style="padding:16px;background-color:#FFF3E0;border-radius:6px;margin-bottom:24px;">
                ...
                <p style="margin:0;color:#5A6C7D;font-size:13px;line-height:1.6;">Please process this order within 24 hours
                    to maintain your seller rating.</p>
            </div>
            ...
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                <tr>
                    <td align="center" style="padding-bottom:12px;">
                        <a href="{{ $process_order_url }}"
                            style="display:inline-block;padding:14px 32px;background-color:#FF6B35;color:#ffffff;text-decoration:none;border-radius:6px;font-weight:600;font-size:16px;box-shadow:0 4px 12px rgba(255,107,53,0.3);">Process
                            Order</a>
                    </td>
                </tr>
                <tr>
                    <td align="center">
                        <a href="{{ $print_packing_slip_url }}"
                            style="display:inline-block;padding:14px 32px;background-color:#F7F9FC;color:#FF6B35;text-decoration:none;border-radius:6px;font-weight:600;font-size:16px;border:2px solid #FF6B35;">Print
                            Packing Slip</a>
                    </td>
                </tr>
            </table>
