...
@section('content')
    <tr>
        <td style="padding:40px 40px 32px;">
            ...
            <p style="margin:0 0 24px;color:#5A6C7D;font-size:16px;line-height:1.6;">We're thrilled to have you join our
                community of shoppers. Get ready to discover amazing products from vendors around the world.</p>
                ...
                <tr>
                    <td align="center">
                        <a href="{{ config('app.url') }}"
                            style="display:inline-block;padding:14px 32px;background-color:#FF6B35;color:#ffffff;text-decoration:none;border-radius:6px;font-weight:600;font-size:16px;box-shadow:0 4px 12px rgba(255,107,53,0.3);">Start
                            Shopping</a>
                    </td>
                </tr>
            </table>
