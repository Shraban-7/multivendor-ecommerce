        ...
        <div class="card mt-3">
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    @if($sale->image)
                        <img src="{{ asset('uploads/flash_sale/'.$sale->image) }}" width="120">
                    @endif
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="description" class="form-control" rows="3">{{ $sale->description }}</textarea>
                </div>
                ...
                <div class="form-check form-switch mb-3">
                    <input class="form-check-input" name="is_active" type="checkbox"
                        value="1" {{ $sale->is_active ? 'checked' : '' }}>
