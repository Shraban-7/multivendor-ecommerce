...
@section('content')
    <div class="mb-3 d-flex justify-content-between align-items-center">
        ...
        <button class="btn btn-theme btn-sm" data-bs-toggle="modal" data-bs-target="#addColorModal">
    ...
    <div class="table-responsive">
        <table class="table mb-3 bg-white table-bordered">
            ...
            <tbody>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="d-flex gap-2 align-items-center">
                                                <input type="color" class="form-control form-control-color w-auto" name="hex_code" value="{{ $color->hex_code }}" style="width:50px;height:38px;">
                                                <input type="text" class="form-control" name="hex_code_text" value="{{ $color->hex_code }}" placeholder="#FFFFFF" maxlength="7">
                                            </div>
                                        </div>
                                        <div class="mb-3">
                ...
                @empty
                    <tr>
                        <td colspan="8" class="text-center text-muted py-4">No colors found.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
            ...
            <div class="modal-content">
                <form method="POST" action="{{ route('admin.colors.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <label class="form-label fw-bold">Name</label>
                            <input type="text" class="form-control" name="name" placeholder="e.g. Midnight Blue" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label fw-bold">Hex Code</label>
                            <div class="d-flex gap-2 align-items-center">
                                <input type="color" class="form-control form-control-color w-auto" name="hex_code" value="#000000" style="width:50px;height:38px;">
                                <input type="text" class="form-control" name="hex_code_text" value="#000000" placeholder="#FFFFFF" maxlength="7">
                            </div>
                        </div>
                        <div class="mb-3">
...
<script>
    document.querySelectorAll('input[name="hex_code"]').forEach(picker => {
        const textInput = picker.closest('.d-flex').querySelector('input[name="hex_code_text"]');
        if (textInput) {
