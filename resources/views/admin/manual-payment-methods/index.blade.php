            ...
            <form
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label class="form-label">Image (Logo/QR)</label>
                            <input
                                type="file"
                                name="image"
                                id="image"
                                class="form-control"
                                accept="image/*" />
                            <small class="text-muted">Upload small logo or QR image.</small>
                        </div>
                        <div class="col-md-6">
...
<script>
    ...
    function openEditModal(method) {
        ...
        document.getElementById("slug").value = method.slug;
        ...
        document
            ...
            .setAttribute(
                "action",
                `/admin/manual-payments/${method.id}`
            );
