    ...
    <div class="bg-white border border-border rounded-sm shadow-sm overflow-hidden mb-3">
        <div class="px-5 py-4 border-b border-border bg-white flex items-center justify-between bg-white">
            <div class="flex flex-wrap justify-between items-center gap-3">
                ...
                <select class="w-full px-3 py-2 text-sm text-ink bg-white border border-border rounded-xs focus:outline-none focus:border-brand-deep focus:ring-1 focus:ring-brand-deep transition-colors w-auto">
                    ...
                    <tbody>
                        @foreach ($sellers as $seller)
                            <tr>
                                    ...
                                    <div class="flex items-center">
                                        <div class="seller-avatar me-2">
                                            <img src="{{ $seller->businessAvatar }}" height="36" width="36"
                                                style="object-fit:scale-down;" class="border">
                                        </div>
                                        <div>
                                ...
                                <td class="text-right">
                                    <a class="btn btn-primary btn-sm btn-icon me-1 mb-1"
