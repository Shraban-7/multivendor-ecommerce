    ...
    <table class="table table-bordered bg-white mb-3">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <div class="d-flex">
                        <a class="btn btn-sm btn-light border me-1 mb-1" href="{{ route('admin.admins.edit', $admin->id) }}">
                            <i class="ri-edit-box-line icon-xs me-1"></i>Edit
                        </a>
                        @if($admin->name != 'Super Admin')
                        <form action="{{ route('admin.admins.delete', $admin->id) }}" method="POST" class="m-0">
                            @csrf
