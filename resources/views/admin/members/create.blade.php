            ...
            <div class="flex flex-wrap items-start justify-between gap-4">
                <div class="min-w-0">
                    <nav class="flex items-center gap-1 mb-2 text-xs text-ink-tertiary">
                        ...
                        <a href="{{ route('admin.admins.index') }}" class="hover:text-ink-soft transition-colors">Admin
                            Members</a>
                    ...
                    <p class="text-sm text-ink-secondary mb-0">Invite a teammate to access the admin panel and assign their
                        starting role.</p>
                </div>
                <div>
            ...
            <section class="bg-white rounded-sm shadow-sm overflow-hidden">
                ...
                <form action="{{ route('admin.admins.store') }}" method="POST" class="p-5 space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-xs font-semibold text-ink-secondary mb-1 uppercase tracking-wider">Full
                                name </label>
                        ...
                        <div>
                            <label
                                class="block text-xs font-semibold text-ink-secondary mb-1 uppercase tracking-wider">Email
                            </label>
                    ...
                    <div>
                        <label class="block text-xs font-semibold text-ink-secondary mb-1 uppercase tracking-wider">Assign
                            role </label>
                        ...
                        <small class="text-ink-tertiary mt-1 block">Roles control which areas of the admin panel this user
                            can access.</small>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label
                                class="block text-xs font-semibold text-ink-secondary mb-1 uppercase tracking-wider">Password
                            </label>
                        ...
                        <div>
                            <label
                                class="block text-xs font-semibold text-ink-secondary mb-1 uppercase tracking-wider">Confirm
                                password </label>
                    ...
                    <div class="bg-amber-50 rounded-xs p-3 flex items-start gap-2 text-xs text-ink-secondary">
                        <i data-lucide="info" class="text-feedback-warning shrink-0 mt-0.5"
                            style="width:14px;height:14px;"></i>
                        <span>The admin must reset their password after first login. Choose a strong password — at least 8
                            characters.</span>
                    </div>
            ...
            <section class="bg-white rounded-sm shadow-sm overflow-hidden">
                ...
                <div class="p-5">
                    <ul class="space-y-3 mb-0">
                        <li class="flex gap-3">
                            <span
                                class="shrink-0 w-7 h-7 rounded-sm bg-brand-tint text-brand-deep flex items-center justify-center"><i
                                    data-lucide="user-check" style="width:14px;height:14px;"></i></span>
                            <div>
                        ...
                        <li class="flex gap-3">
                            <span
                                class="shrink-0 w-7 h-7 rounded-sm bg-info-tint text-feedback-info flex items-center justify-center"><i
                                    data-lucide="mail" style="width:14px;height:14px;"></i></span>
                            <div>
                        ...
                        <li class="flex gap-3">
                            <span
                                class="shrink-0 w-7 h-7 rounded-sm bg-warning-tint text-feedback-warning flex items-center justify-center"><i
                                    data-lucide="key-round" style="width:14px;height:14px;"></i></span>
                            <div>
                        ...
                        <li class="flex gap-3">
                            <span
                                class="shrink-0 w-7 h-7 rounded-sm bg-emerald-50 text-feedback-success flex items-center justify-center"><i
                                    data-lucide="shield-check" style="width:14px;height:14px;"></i></span>
                            <div>
