...
<div class="row">
    ...
    <div class="col-lg-8">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-8">
                        ...
                        <div class="mb-2 d-flex flex-wrap gap-2">
                            ...
                            <span class="badge border bg-light text-dark small">{{ $product->subcategory->name }}</span>
                            @endif
        ...
        @include('seller.includes.product-seo-form')
    </div>

    <div class="col-lg-4">
        @include('seller.includes.stock-section')
    </div>
</div>

@include('seller.includes.product-details-modals')
