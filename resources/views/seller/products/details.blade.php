                                    ...
                                    <div class="row">
                                        ...
                                        @foreach ($product->variants as $variant)
                                            <div class="col-12 col-md-6 col-lg-4 g-3">
                                                <div class="card shadow-sm mb-3" style="width: 18rem; position: relative; overflow: hidden;">

                                                    <div class="position-relative">
                                                        @if ($variant['image'])
                                                            <img src="{{ storage_url($variant->image) }}" class="card-img-top" alt="Variant Image" style="height: 180px; object-fit: cover;">
                                                        @endif

                                                        @if ($variant['is_default'])
                                                            <span class="badge bg-success position-absolute top-0 start-0 m-2">Default</span>
                                                        @endif
                                                    </div>
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        @foreach ($variant->option_values as $option_value)
                                                            <p class="mb-1 small text-muted">{{ $option_value->option->name }}: {{ $option_value->value }}</p>
                                                        @endforeach
                                                        <hr>
                                                        <div class="d-flex flex-wrap small text-muted mt-3">
                                                            <div class="me-3">Stock: <strong>{{ $variant->stock }}</strong></div>
                                                            <div class="me-3">Price: <strong>{{ money($variant->selling_price) }}</strong></div>
                                                            <div>Discount: <strong>{{ money($variant->discounted_price) }}</strong></div>
                                                        </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="mb-3 col-md-6">
                                                                        ...
                                                                        <select name="discount_type"
                                                                            ...
                                                                            <option value="" selected disabled>
                                                                                --Choose--</option>
                                                                            <option
                                                                                value="{{ \App\Enums\DiscountType::FLAT->value }}" {{ \App\Enums\DiscountType::FLAT->value== $variant->discount_type ? 'selected' : '' }}>
                                                                                {{ ucfirst(\App\Enums\DiscountType::FLAT->label()) }}
                                                                            </option>
                                                                            <option
                                                                                value="{{ \App\Enums\DiscountType::PERCENTAGE->value }}" {{ \App\Enums\DiscountType::PERCENTAGE->value== $variant->discount_type ? 'selected' : '' }}>
                                                                    ...
                                                                    <div class="mb-3 col-md-6">
                                                                        ...
                                                                        <input name="discount_value" type="number"
                                                                            value="{{ $variant->discount_value }}" class="form-control" required>
                                                                    </div>
                                                                    <div class="mb-3 col-md-12">
                                                                        <label class="form-label">Low Stock
                                                                            Quantity</label>
                                                                        <input name="low_stock_quantity" type="number"
                                                                            value="{{ $variant->low_stock_quantity }}" class="form-control">
                                                                    </div>
