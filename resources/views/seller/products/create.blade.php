...
<div class="card">
    ...
    <div class="card-body">
        <div id="alertBox"></div>
        <form id="form" method="POST" action="{{ route('seller.products.store') }}"
            ...
            <div class="row">
                ...
                <div class="mb-3 col-md-4">
                    ...
                    <input name="sku" type="text" value="{{ \App\Models\ProductVariant::generate_sku() }}" class="form-control" required>
                </div>
                    ...
                    <div style="width: 250px;">
                        <div class="form-group">
                            <div class="image-preview border bg-light d-flex justify-content-center text-center align-items-center position-relative"
                                ...
                                <img src="{{ asset('assets/frontend/images/default.png') }}" alt="image" class="img-fluid rounded"
