                ...
                <div class="card-body">
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item d-flex justify-content-between px-0">
                            <span>Date:</span>
                            <span
                                class="fw-medium">{{ \Carbon\Carbon::parse($order->created_at)->format('d-m-Y h:i A') }}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between px-0">
                            <span>Status:</span>
                            <span>
                    ...
                    <div class="card border-0 shadow-sm h-100">
                        ...
                        <div class="card-body">
                            ...
                            <p class="mb-0"><i data-feather="user" class="icon-xs me-1"></i> Customer since
                                {{ \Carbon\Carbon::parse($order->user->created_at)->format('M Y') }}</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-3">
                            <p class="mb-0 mt-2"><span
                                    class="fw-medium me-2">Review:</span>{{ $order->review->review_text }}</p>
                        </div>
