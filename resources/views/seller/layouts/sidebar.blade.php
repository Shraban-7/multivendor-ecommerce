...
<nav class="navbar-vertical navbar" id="sellerSidebar">
    <a class="navbar-brand flex items-center gap-3 px-4 py-3 border-b" href="/"
    ...
    <div class="sidebar-scroll">
        <ul class="navbar-nav flex-col mb-0" id="sideNavbar">
            ...
            {{-- ═══ 1. MAIN ═══ --}}
            <div class="sidebar-heading px-4 pt-3 pb-1 uppercase font-semibold">Main</div>

            <li class="nav-item">
                <a class="nav-link flex items-center {{ request()->routeIs('seller.dashboard') ? 'active' : '' }}"
            ...
            {{-- ═══ 2. SHIPPING ═══ --}}
            <div class="sidebar-heading px-4 pt-3 pb-1 uppercase font-semibold">Shipping</div>

            <li class="nav-item">
                <a class="nav-link flex items-center {{ request()->routeIs('seller.shipping.shipments*') ? 'active' : '' }}"
            ...
            <li class="nav-item">
                <a class="nav-link flex items-center {{ request()->routeIs('seller.shipping.zones*') ? 'active' : '' }}"
            ...
            {{-- ═══ 3. CATALOG ═══ --}}
            <div class="sidebar-heading px-4 pt-3 pb-1 uppercase font-semibold">Catalog</div>

            <li class="nav-item">
                <a class="nav-link has-arrow collapsed flex justify-between items-center" href="#!"
                ...
                <div id="navProducts" class="collapse {{ $productMenuOpen ? 'show' : '' }}" data-bs-parent="#sideNavbar">
                    <ul class="nav flex-col">
                        @if ($seller || $employee->hasPermission('seller.products.index'))
                            <li class="nav-item">
                                <a class="nav-link flex items-center {{ request()->routeIs('seller.products.index') || request()->routeIs('seller.products.show') || request()->routeIs('seller.products.edit') ? 'active' : '' }}"
                        ...
                        @if ($seller || $employee->hasPermission('seller.products.create'))
                            <li class="nav-item">
                                <a class="nav-link flex items-center {{ request()->routeIs('seller.products.create') ? 'active' : '' }}"
                        ...
                        @if ($seller || $employee->hasPermission('seller.products.inventory'))
                            <li class="nav-item">
                                <a class="nav-link flex items-center {{ request()->routeIs('seller.products.inventory') ? 'active' : '' }}"
                        ...
                        @if ($seller || $employee->hasPermission('seller.stock.index'))
                            <li class="nav-item">
                                <a class="nav-link flex items-center {{ request()->routeIs('seller.stock.*') ? 'active' : '' }}"
                        ...
                        @if ($seller || $employee->hasPermission('seller.bulk-upload.index'))
                            <li class="nav-item">
                                <a class="nav-link flex items-center {{ request()->routeIs('seller.bulk-upload.*') ? 'active' : '' }}"
                        ...
                        @if ($seller || $employee->hasPermission('seller.bundles.index'))
                            <li class="nav-item">
                                <a class="nav-link flex items-center {{ request()->routeIs('seller.bundles.*') ? 'active' : '' }}"
                        ...
                        @if ($seller || $employee->hasPermission('seller.products.printBarcode'))
                            <li class="nav-item">
                                <a class="nav-link flex items-center {{ request()->routeIs('seller.products.printBarcode*') ? 'active' : '' }}"
            ...
            {{-- ═══ 4. REVIEWS ═══ --}}
            <div class="sidebar-heading px-4 pt-3 pb-1 uppercase font-semibold">Reviews</div>

            @if ($seller || $employee->hasPermission('seller.reviews.index'))
                <li class="nav-item">
                    <a class="nav-link flex items-center {{ request()->routeIs('seller.reviews.*') ? 'active' : '' }}"
            ...
            {{-- ═══ 5. PROMOTIONS ═══ --}}
            <div class="sidebar-heading px-4 pt-3 pb-1 uppercase font-semibold">Promotions</div>

            <li class="nav-item">
                <a class="nav-link flex items-center {{ request()->routeIs('seller.flash-sales.*') ? 'active' : '' }}"
            ...
            @if ($seller || $employee->hasPermission('seller.coupons.index'))
                <li class="nav-item">
                    ...
                    <div id="navCoupons" class="collapse {{ request()->routeIs('seller.coupons.*') ? 'show' : '' }}" data-bs-parent="#sideNavbar">
                        <ul class="nav flex-col">
                            <li class="nav-item">
                                <a class="nav-link flex items-center {{ request()->routeIs('seller.coupons.index') ? 'active' : '' }}"
                            ...
                            <li class="nav-item">
                                <a class="nav-link flex items-center {{ request()->routeIs('seller.coupons.create') ? 'active' : '' }}"
                            ...
                            <li class="nav-item">
                                <a class="nav-link flex items-center {{ request()->routeIs('seller.coupons.analytics') ? 'active' : '' }}"
            ...
            {{-- ═══ 5. ORDERS ═══ --}}
            <div class="sidebar-heading px-4 pt-3 pb-1 uppercase font-semibold">Orders</div>
                ...
                <div id="navOrders" class="collapse {{ request()->routeIs('seller.orders.*') ? 'show' : '' }}" data-bs-parent="#sideNavbar">
                    <ul class="nav flex-col">
                        @if ($seller || $employee->hasPermission('seller.orders.index'))
                            <li class="nav-item">
                                <a class="nav-link flex items-center {{ request()->routeIs('seller.orders.index') ? 'active' : '' }}"
                        ...
                        @if ($seller || $employee->hasPermission('seller.orders.pending'))
                            <li class="nav-item">
                                <a class="nav-link flex items-center {{ request()->routeIs('seller.orders.pending') ? 'active' : '' }}"
                        ...
                        @if ($seller || $employee->hasPermission('seller.orders.shipped'))
                            <li class="nav-item">
                                <a class="nav-link flex items-center {{ request()->routeIs('seller.orders.shipped') ? 'active' : '' }}"
                        ...
                        @if ($seller || $employee->hasPermission('seller.orders.delivered'))
                            <li class="nav-item">
                                <a class="nav-link flex items-center {{ request()->routeIs('seller.orders.delivered') ? 'active' : '' }}"
                        ...
                        @if ($seller || $employee->hasPermission('seller.orders.returned'))
                            <li class="nav-item">
                                <a class="nav-link flex items-center {{ request()->routeIs('seller.orders.returned') ? 'active' : '' }}"
                        ...
                        @if ($seller || $employee->hasPermission('seller.orders.refunded'))
                            <li class="nav-item">
                                <a class="nav-link flex items-center {{ request()->routeIs('seller.orders.refunded') ? 'active' : '' }}"
                        ...
                        @if ($seller || $employee->hasPermission('seller.orders.cancelled'))
                            <li class="nav-item">
                                <a class="nav-link flex items-center {{ request()->routeIs('seller.orders.cancelled') ? 'active' : '' }}"
                        ...
                        @endif
                        <li class="nav-item">
                            <a class="nav-link flex items-center {{ request()->routeIs('seller.returns.*') ? 'active' : '' }}"
            ...
            @if ($seller || $employee->hasPermission('seller.performance.dashboard'))
                <li class="nav-item">
                    <a class="nav-link flex items-center {{ request()->routeIs('seller.performance.*') ? 'active' : '' }}"
            ...
            @if ($seller || $employee->hasPermission('seller.support.index'))
                <li class="nav-item">
                    <a class="nav-link flex items-center {{ request()->routeIs('seller.support.*') ? 'active' : '' }}"
            ...
            {{-- ═══ 9. PEOPLE ═══ --}}
            <div class="sidebar-heading px-4 pt-3 pb-1 uppercase font-semibold">People</div>

            <li class="nav-item">
                <a class="nav-link flex items-center {{ request()->routeIs('seller.customers') ? 'active' : '' }}"
                ...
                <div id="navEmployees" class="collapse {{ request()->routeIs('seller.employees.*') ? 'show' : '' }}" data-bs-parent="#sideNavbar">
                    <ul class="nav flex-col">
                        @if ($seller || $employee->hasPermission('seller.employees.index'))
                            <li class="nav-item">
                                <a class="nav-link flex items-center {{ request()->routeIs('seller.employees.index') || request()->routeIs('seller.employees.edit') || request()->routeIs('seller.employees.profile') ? 'active' : '' }}"
                        ...
                        @if ($seller || $employee->hasPermission('seller.employees.create'))
                            <li class="nav-item">
                                <a class="nav-link flex items-center {{ request()->routeIs('seller.employees.create') ? 'active' : '' }}"
                        ...
                        @if ($seller || $employee->hasPermission('seller.employees.salesReport'))
                            <li class="nav-item">
                                <a class="nav-link flex items-center {{ request()->routeIs('seller.employees.salesReport') ? 'active' : '' }}"
            ...
            @if ($seller || $employee->hasPermission('seller.chat.list'))
                <li class="nav-item">
                    <a class="nav-link flex items-center {{ request()->routeIs('seller.chat.*') ? 'active' : '' }}"
            ...
            {{-- ═══ 10. FINANCE ═══ --}}
            <div class="sidebar-heading px-4 pt-3 pb-1 uppercase font-semibold">Finance</div>

            @if ($seller || $employee->hasPermission('seller.expenses.index'))
                <li class="nav-item">
                    <a class="nav-link flex items-center {{ request()->routeIs('seller.expenses.*') ? 'active' : '' }}"
            ...
            @if ($seller || $employee->hasPermission('seller.payouts.index'))
                <li class="nav-item">
                    ...
                    <div id="navPayouts" class="collapse {{ request()->routeIs('seller.payouts.*') ? 'show' : '' }}" data-bs-parent="#sideNavbar">
                        <ul class="nav flex-col">
                            <li class="nav-item">
                                <a class="nav-link flex items-center {{ request()->routeIs('seller.payouts.index') && !request()->routeIs('seller.payouts.create') && !request()->routeIs('seller.payouts.methods.*') ? 'active' : '' }}"
                            ...
                            <li class="nav-item">
                                <a class="nav-link flex items-center {{ request()->routeIs('seller.payouts.create') ? 'active' : '' }}"
                            ...
                            <li class="nav-item">
                                <a class="nav-link flex items-center {{ request()->routeIs('seller.payouts.methods.*') ? 'active' : '' }}"
            ...
            {{-- ═══ 9. REPORTS ═══ --}}
            <div class="sidebar-heading px-4 pt-3 pb-1 uppercase font-semibold">Reports</div>
            ...
            <li class="nav-item">
                ...
                <div id="navReports" class="collapse {{ request()->routeIs('seller.reports.*') ? 'show' : '' }}" data-bs-parent="#sideNavbar">
                    <ul class="nav flex-col">
                        <li class="nav-item">
                            <a class="nav-link flex items-center {{ request()->routeIs('seller.reports.overview') ? 'active' : '' }}"
                        ...
                        <li class="nav-item">
                            <a class="nav-link flex items-center {{ request()->routeIs('seller.reports.financial') ? 'active' : '' }}"
                        ...
                        <li class="nav-item">
                            <a class="nav-link flex items-center {{ request()->routeIs('seller.reports.sales') ? 'active' : '' }}"
                        ...
                        <li class="nav-item">
                            <a class="nav-link flex items-center {{ request()->routeIs('seller.reports.customers') ? 'active' : '' }}"
            ...
            {{-- ═══ 10. SYSTEM ═══ --}}
            <div class="sidebar-heading px-4 pt-3 pb-1 uppercase font-semibold">System</div>

            @if ($seller || $employee->hasPermission('seller.settings.index'))
                <li class="nav-item">
                    <a class="nav-link flex items-center {{ request()->routeIs('seller.settings.*') ? 'active' : '' }}"
            ...
            @if ($seller || $employee->hasPermission('seller.paymentListener.index'))
                <li class="nav-item">
                    <a class="nav-link flex items-center {{ request()->routeIs('seller.paymentListener.*') ? 'active' : '' }}"
            ...
            <li class="nav-item">
                <a class="nav-link flex items-center {{ request()->routeIs('seller.plans.*') ? 'active' : '' }}"
