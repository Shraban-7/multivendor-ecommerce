            ...
            <div class="bg-white rounded-sm shadow-sm overflow-hidden flex-1 flex flex-col">
                ...
                <div class="p-5 grow">
                    <div class="grid grid-cols-1 gap-3">
                        <div>
                            <label
                                class="block text-[11px] font-semibold text-ink-tertiary mb-1 uppercase tracking-wider">Current
                                Password</label>
                        ...
                        <div>
                            <label
                                class="block text-[11px] font-semibold text-ink-tertiary mb-1 uppercase tracking-wider">New
                                Password</label>
                        ...
                        <div>
                            <label
                                class="block text-[11px] font-semibold text-ink-tertiary mb-1 uppercase tracking-wider">Confirm
                                Password</label>
            ...
            $(function() {
                $('#personalForm, #passwordForm').on('submit', function(e) {
                    ...
                    $.ajax({
                        ...
                        error: function(xhr) {
                            btn.prop('disabled', false).html(
                                '<i data-lucide="refresh-cw" style="width:14px;height:14px;"></i> Save'
                                );
                            if (window.renderIcons) {
                                window.renderIcons();
                            }
