            ...
            <form id="businessSettingsForm" action="{{ route('seller.settings.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <input type="file" id="files" class="form-control mb-3" name="files[]" multiple accept="image/*">
                            ...
                            @foreach ($seller->banner_images as $banner)
                                <div class="col-md-3 mb-3 banner-item" id="banner-{{ $banner->id }}">
                                    <div class="position-relative">
                                        <img src="{{ storage_url($banner->image) }}" class="img-fluid rounded" alt="Banner">
                                        <button type="button"
...
$(function () {
    ...
    const $previewContainer = $("#new-banners");
    ...
    $fileInput.on("change", function () {
        ...
        Array.from(files).forEach((file, index) => {
            ...
            reader.onload = function (e) {
                const html = `
                    <div class="col-md-3 mb-3 preview-item" data-index="${index}">
                        <div class="position-relative">
