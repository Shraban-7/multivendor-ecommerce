    ...
    <div class="p-5 lg:p-6 pt-6">
        <div class="flex flex-wrap items-start justify-between gap-4">
            <div class="min-w-0">
                ...
                <p class="text-sm text-ink-secondary mb-0">Provide as much detail as possible so our admin team can help quickly.</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
                ...
                <div class="md:col-span-8">
                    <label class="block text-[11px] font-semibold text-ink-tertiary mb-1 uppercase tracking-wider">
                        Subject <span class="text-feedback-danger">*</span>
                    </label>
                    <div class="relative">
                        <i data-lucide="type" class="absolute top-1/2 -translate-y-1/2 text-ink-tertiary" style="width:14px;height:14px; left: 10px;"></i>
                        <input type="text" name="subject" maxlength="200"
                               value="{{ old('subject') }}" required placeholder="Short, descriptive summary…"
                    ...
                    @error('subject') <div class="text-feedback-danger text-xs mt-1">{{ $message }}</div> @enderror
                </div>

                {{-- Priority --}}
                <div class="md:col-span-4">
                    <label class="block text-[11px] font-semibold text-ink-tertiary mb-1 uppercase tracking-wider">
                        Priority <span class="text-feedback-danger">*</span>
                    </label>
                    <div class="relative">
                        <i data-lucide="flag" class="absolute top-1/2 -translate-y-1/2 text-ink-tertiary" style="width:14px;height:14px; left: 10px;"></i>
                ...
                <div class="md:col-span-6">
                    <label class="block text-[11px] font-semibold text-ink-tertiary mb-1 uppercase tracking-wider">
                        Category <span class="text-feedback-danger">*</span>
                    </label>
                    <div class="relative">
                        <i data-lucide="tag" class="absolute top-1/2 -translate-y-1/2 text-ink-tertiary" style="width:14px;height:14px; left: 10px;"></i>
                ...
                <div class="md:col-span-6">
                    ...
                    <div class="relative">
                        <i data-lucide="package" class="absolute top-1/2 -translate-y-1/2 text-ink-tertiary" style="width:14px;height:14px; left: 10px;"></i>
                ...
                <div class="md:col-span-12">
                    <label class="block text-[11px] font-semibold text-ink-tertiary mb-1 uppercase tracking-wider">
                        Describe the Issue <span class="text-feedback-danger">*</span>
                    </label>
                    ...
                    @error('description') <div class="text-feedback-danger text-xs mt-1">{{ $message }}</div> @enderror
                </div>
            </div>
