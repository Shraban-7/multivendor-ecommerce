            ...
            <div class="card-body">
                <form method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="variant_id" class="form-select" id="product" required>
                    ...
                    <div class="d-flex justify-content-between">
                        <button type="button" id="generate" class="btn btn-primary">Generate Labels</button>
                        <button type="button" id="generate" class="btn btn-dark">
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        productSelect.addEventListener('change', function() {
            ...
            const price = opt.dataset.discountedprice && opt.dataset.discountedprice !== '0' ? opt.dataset.discountedprice : opt.dataset.sellingprice;
            priceInput.value = price;
            qtyInput.value = opt.dataset.stock;
        });
        ...
        //     if (!sku || !name || !price || !qty) return;

        //     for (let i = 0; i < qty; i++) {
        //         const wrap = document.createElement('div');
        //         wrap.className = 'label-preview p-2 border text-center m-1 ';
        //         wrap.style.width = '160px';
        //         wrap.innerHTML = `
        //         <div class="small mb-1">${name}</div>
        //         <svg class="barcode" jsbarcode-value="${sku}" jsbarcode-height="40" jsbarcode-fontSize="12"></svg>
        //         <div class="small mt-1">Price: ${price}</div>
        //     `;
        //         labelsDiv.appendChild(wrap);
        //     }
        //     //JsBarcode(".barcode").init();
        //     JsBarcode(".barcode", null, {
        //         format: "CODE128",
        //         width: 1.2,
        //         displayValue: true,
        //         fontSize: 11,
