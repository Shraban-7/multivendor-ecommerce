    ...
    <main class="pb-10">
        <section class="container section-padding my-12 md:my-16">
            <div class="mx-auto max-w-lg flex flex-col items-center text-center gap-3 md:gap-4">
                <span
                    class="mb-2 flex h-14 w-14 xsm:h-16 xsm:w-16 items-center justify-center rounded-full border-2 xsm:border-[5px] border-amber-500 bg-amber-500/15 text-3xl xsm:text-4xl text-amber-600">
                ...
                <p class="text-sm text-davy-gray w-11/12 sm:w-4/5">
                    You cancelled the payment. No charge was made. You can try again from your orders anytime.
                </p>
