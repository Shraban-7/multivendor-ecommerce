    ...
    public function run(): void
    {
        $banners =[
            [
                ...
                'button_link' => '#',
                'image' => 'images/hero_banners/hero-image-1.png',
                'is_active' => true,
                'position' => 1,
            ],
            [
                ...
                'button_link' => '#',
                'image' => 'images/hero_banners/hero-image-2.png',
                'is_active' => true,
                'position' => 2,
            ],
            [
                ...
                'button_text' => '',
                'button_link' => '#',
                'image' => 'images/hero_banners/hero-image-3.png',
                'is_active' => true,
                'position' => 3,
            ],
            [
                ...
                'button_link' => '#',
                'image' => 'images/hero_banners/hero-image-4.png',
                'is_active' => true,
                'position' => 4,
            ],
            [
                ...
                'button_text' => '',
                'button_link' => '#',
                'image' => 'images/hero_banners/hero-image-5.jpg',
                'is_active' => true,
                'position' => 5,
            ],
        ];
